...
~~~~~~~~~~~
        ...
        4. Add example_high_load_memory_use() to [example_entry.c]
        ...
        5. Add example_high_load_memory_use example source files to project
        (a) For IAR project, add high_load_memory_use example to group <example> 
            $PROJ_DIR$\..\..\..\component\common\example\high_load_memory_use\example_high_load_memory_use.c
        (b) For GCC project, add high_load_memory_use example to example Makefile
