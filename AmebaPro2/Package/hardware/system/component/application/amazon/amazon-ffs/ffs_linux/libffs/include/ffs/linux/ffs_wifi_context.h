 ...
 */
typedef struct FfsLinuxWifiContext_s {
    ...
    _mutex scanListMutex; //!< Scan list mutex.
    time_t lastBackgroundScanTime; //!< Last background scan time.
    ...
    _sema ffsTaskWifiScanSemaphore;
    int wifi_scan_count_idx;
