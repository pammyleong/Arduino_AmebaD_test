 ...
 */
FFS_RESULT ffsGetDerEncodedPublicKeyFromEVPKey(mbedtls_pk_context *pkey, FfsStream_t *derStream);
 ...
 * @returns Enumerated [result](@ref FFS_RESULT)
 */
FFS_RESULT ffsGetEVPKeyFromDerStream(FfsStream_t *derStream, unsigned char **pkey);
