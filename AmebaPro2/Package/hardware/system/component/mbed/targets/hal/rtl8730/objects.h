...
/** @addtogroup MBED_GPIOIRQ
 *  @brief      MBED_GPIOIRQ driver modules.
 *  @{
 */

/** @addtogroup MBED_GPIOIRQ_Exported_Types MBED_GPIOIRQ Exported Types
  * @{
  */
...
/** @addtogroup MBED_GPIOPORT
 *  @brief      MBED_GPIOPORT driver modules.
 *  @{
 */

/** @addtogroup MBED_GPIOPORT_Exported_Types MBED_GPIOPORT Exported Types
  * @{
  */
struct port_s {
	PortName port;
