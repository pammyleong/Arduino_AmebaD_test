...
#ifndef CONFIG_USB_AUTOINSTALL_ENABLED
...
#else
#define FLASH_RESERVED_DATA_BASE		0x4000  // reserve 32K for Image1
#define FLASH_SYSTEM_DATA_ADDR		0x5000  // reserve 32K+4K for Image1 + Reserved data
#define FLASH_OTA1_CODE_ADDR			0x8020
#endif
