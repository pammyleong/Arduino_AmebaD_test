...
extern int BOOT_FLASH_IsJtagKeyMatch(u8 *inputkey);
...
int rom_ed25519_gen_keypair(unsigned char pk[],
                            unsigned char skpk[], 
                            unsigned char seed[]);
int rom_ed25519_gen_signature(unsigned char sig[],
                              const unsigned char *m, unsigned long long mlen,
                              const unsigned char skpk[]);
int rom_ed25519_verify_signature(const unsigned char sig[],
                                 const unsigned char *m, unsigned long long mlen,
