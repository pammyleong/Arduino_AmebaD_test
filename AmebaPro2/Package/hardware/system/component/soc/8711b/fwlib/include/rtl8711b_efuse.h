...
/** @defgroup EFUSE_Physical_Address_functions 
  * @{
  */
_LONG_CALL_ extern u8 EFUSE_LogicalMap_Write_Check(u32 addr, u32 cnts, u8 *data); //AZ BCUT ADD
_LONG_CALL_ extern u32 EFUSE_Write8_WithCheck(u32 CtrlSetting, u16 Addr, u8 Data, u8 L25OutVoltage); //AZ BCUT ADD
...
#define EFUSE_PHYSICAL_SBOOT_ON		BIT(1)	/* 0: Security BOOT ON, default 1: Security BOOT OFF */

extern u8 EFUSE_MAP[512];
extern int RBSS_LMAP_PG_HEADER_FAIL;
...
#define EFUSE_LMAP_WRITE			EFUSE_LogicalMap_Write_Check_ACUT
#define EFUSE_PMAP_READ8			EFUSE_OneByteRead_ACUT
#define EFUSE_WRITE_CHECK			EFUSE_WRITE_Check_ACUT
#define LMAP_PG_HEADER_FAIL		LMAP_PG_HEADER_FAIL_ACUT
#else
...
#define EFUSE_PMAP_READ8			EFUSE_OneByteReadROM
#define EFUSE_WRITE_CHECK			EFUSE_WRITE_Check
#define LMAP_PG_HEADER_FAIL		RBSS_LMAP_PG_HEADER_FAIL
#endif
