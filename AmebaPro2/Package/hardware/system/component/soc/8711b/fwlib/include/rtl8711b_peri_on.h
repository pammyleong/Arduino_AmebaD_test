...
//0x02E0 REG_HCI_CTRL_STATUS_0
#define BIT_SDIO_FUNC_EN					BIT(0) /* After efuse sdio enable, this bit will enable by hardware when power up */
#define SDIOD_FCTRL(ctrl)					HAL_PERL_ON_FUNC_CTRL(REG_HCI_CTRL_STATUS_0, BIT_SDIO_FUNC_EN, ctrl)
