...
/**************************************************************************//**
 * @defgroup APM DEVICE
 * @brief PSRAM APM DEVICE register
 * @{
 *****************************************************************************/
...
/**************************************************************************//**
 * @defgroup WB DEVICE
 * @brief PSRAM WB DEVICE register
 * @{
 *****************************************************************************/
...
/** @defgroup APM_PSRAM_LATENCY_definitions
  * @{
  */
...
/** @defgroup PSRAMP_LATENCY_TYPE_definitions
  * @{
  */
...
/** @defgroup PHY_Latency_definations_definitions
  * @{
  */
...
/** @defgroup WB_PSRAM_LATENCY_definitions
  * @{
  */
#define PSRAM_WB_INIT_FIX_RD_LATENCY_CLK	14
#define PSRAM_WB_INIT_VL_RD_LATENCY_CLK		7

#define PSRAM_WB_INIT_FIX_WR_LATENCY_CLK	14
#define PSRAM_WB_INIT_VL_WR_LATENCY_CLK		7
/**
  * @}
  */
