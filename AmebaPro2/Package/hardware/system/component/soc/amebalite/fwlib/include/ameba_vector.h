...
enum DSPRQn {
	/******  Processor Exceptions Numbers ********/
	NonMaskableInt_IRQn_DSP			= -14,	/*!< 2 Non Maskable Interrupt */
	HardFault_IRQn_DSP			= -13,	/*!< 3 Hard Fault, all classes of Fault */
	MemoryManagement_IRQn_DSP			= -12,	/*!< 4 Cortex-M3 Memory Management Interrupt */
	BusFault_IRQn_DSP			= -11,	/*!< 5 Cortex-M3 Bus Fault Interrupt */
	UsageFault_IRQn_DSP			= -10,	/*!< 6 Cortex-M3 Usage Fault Interrupt */
	SVCall_IRQn_DSP			= -5,	/*!< 11 Cortex-M3 SV Call Interrupt  */
	DebugMonitor_IRQn_DSP			= -4,	/*!< 12 Cortex-M3 Debug Monitor Interrupt */
	PendSV_IRQn_DSP			= -2,	/*!< 14 Cortex-M3 Pend SV Interrupt */
	SysTick_IRQn_DSP			= -1,	/*!< 15 Cortex-M3 System Tick Interrupt */

	/******  Specific Interrupt Numbers ************/
	IPC_DSP_IRQ_DSP			= 0,
	DSP_WDG_INT_IRQ_DSP			= 1,
	TIMER6_IRQ_DSP			= 2,
	TIMER7_IRQ_DSP			= 3,
	TIMER10_IRQ_DSP			= 4,
	TIMER11_IRQ_DSP			= 5,
	...
	GPIOB_IRQ_DSP			= 10,
	CTOUCH_IRQ_DSP			= 11,
	GDMA0_CHANNEL0_IRQ_DSP			= 12,
	GDMA0_CHANNEL1_IRQ_DSP			= 13,
	GDMA0_CHANNEL2_IRQ_DSP			= 14,
	GDMA0_CHANNEL3_IRQ_DSP			= 15,
	SPORT0_IRQ_DSP			= 16,
	SPORT1_IRQ_DSP			= 17,
	VAD_IRQ_DSP			= 18,
	ZIGBEE_IRQ_DSP			= 19,
