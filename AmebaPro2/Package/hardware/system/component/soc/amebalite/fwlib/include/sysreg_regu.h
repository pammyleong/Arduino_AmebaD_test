...
#define REGU_BIT_CORE_LDO_MODE_SEL           ((u32)0x00000001 << 23)          /*!<R/W 0  core ldo mode select 0: reg_standby_L_1209 1: reg_standby_L_1209_slp */
...
#define REGU_MASK_FREQ_R_SEL                 ((u16)0x00FF << 0)          /*!<R/W 10000000  // [RF][4MOSC] REG_CTRL */
...
#define REGU_MASK_IB_BIAS_SEL                ((u16)0x001F << 0)          /*!<R/W 01111  // [RF][4MOSC] REG_CTRL */
...
#define REGU_BIT_OFF_END_SEL                 ((u32)0x00000001 << 29)          /*!<R/W 1  PFM function, COT off time controlled by 0: ZCD 1: min off time */
...
#define REGU_MASK_VREFPFM_L                  ((u32)0x0000000F << 22)          /*!<R/W 1100  SWR/LDO 0000 0.650 0001 0.700 0010 0.750 0011 0.800 0100 0.850 0101 0.900 0110 0.950 0111 1.000 1000 1.050 1001 1.100 1010 1.150 1011 1.200 1100 1.250 1101 1.300 1110 1.350 1111 1.400 */
...
#define REGU_MASK_OCP_L1                     ((u32)0x00000007 << 13)          /*!<R/W 100  SWR OCP threshold PWM current(A) PFM current(A) 000 0.553 0.130 001 0.607 0.156 010 0.662 0.183 011 0.717 0.210 100 0.772 0.240 101 0.826 0.265 110 0.881 0.292 111 0.936 VIN/10 */
 ...
 * @{
 *****************************************************************************/
#define REGU_MASK_SWR_ON_DUMMY1              ((u32)0x00000007 << 29)          /*!<R/W 0  1:Feedback from REGU Internal PAD 0:Feedback from External PAD */
#define REGU_SWR_ON_DUMMY1(x)                ((u32)(((x) & 0x00000007) << 29))
#define REGU_GET_SWR_ON_DUMMY1(x)            ((u32)(((x >> 29) & 0x00000007)))
#define REGU_BIT_VOFB_SEL                    ((u32)0x00000001 << 28)          /*!<R/W 0  1:Feedback from REGU Internal PAD 0:Feedback from External PAD */
 ...
 * @{
 *****************************************************************************/
#define REGU_MASK_SWR_ON_DUMMY2              ((u32)0x0000000F << 0)          /*!<R/W 0  1:Feedback from REGU Internal PAD 0:Feedback from External PAD */
...
#define REGU_BIT_REG_VOFB_SEL                ((u32)0x00000001 << 28)          /*!<R/W 1  0:vo15 1:LX_SPS */
 ...
 * @{
 *****************************************************************************/
#define REGU_MASK_REG_LDO_1209_DUMMY         ((u32)0x00000003 << 14)          /*!<R/W 00  dummy */
...
#define REGU_MASK_REG_DMYLOAD_L_1209         ((u32)0x00000003 << 10)          /*!<R/W 00  // LDO dmy load ctrl // 00(default): dmy load disable // 01: 200kΩ // 10: 125Ω // 11: 125Ω */
#define REGU_REG_DMYLOAD_L_1209(x)           ((u32)(((x) & 0x00000003) << 10))
#define REGU_GET_REG_DMYLOAD_L_1209(x)       ((u32)(((x >> 10) & 0x00000003)))
#define REGU_BIT_REG_ITAIL_HALF_EN_L_1209    ((u32)0x00000001 << 9)          /*!<R/W 0  // [REGU][LDO] REG_CTRL // LDO iq half ctrl // 0(default): iq normal (for normal mode) // 1: iq half (for standby mode) */
#define REGU_MASK_REG_STANDBY_L_1209         ((u32)0x00000003 << 7)          /*!<R/W 00  // [REGU][LDO] REG_CTRL // LDO standby mode ctrl: // 00 :iq=2mA // 01: iq=150uA // 10: iq=1uA */
#define REGU_REG_STANDBY_L_1209(x)           ((u32)(((x) & 0x00000003) << 7))
#define REGU_GET_REG_STANDBY_L_1209(x)       ((u32)(((x >> 7) & 0x00000003)))
#define REGU_BIT_EN_DIODE_L_1209             ((u32)0x00000001 << 6)          /*!<R/W 1  // [REGU][LDO] REG_CTRL // PGATE diode clamp (this gating to disable by pd_regu_L) // 0: disable clamp // 1: enable clamp (default) */
#define REGU_MASK_VOADJ_L_1209               ((u32)0x0000000F << 2)          /*!<R/W 1000  // [REGU][LDO] REG_CTRL // LDO VOSEL // 0000, 0001, 0010, 0011: 0.722, 0.740, 0.760, 0.780 // 0100, 0101, 0110, 0111: 0.802, 0.825, 0.850, 0.875 // 1000(default), 1001, 1010, 1011: 0.903, 0.932, 0.963, 0.997 // 1100, 1101, 1110, 1111: 1.032, 1.071, 1.112, 1.157 */
...
#define REGU_BIT_OP_BUFFER_3318              ((u32)0x00000001 << 12)          /*!<R/W 0  0: PMOS buffer 1: NMOS buffer */
...
#define REGU_MASK_REG_STANDBY_L_3318         ((u32)0x00000003 << 7)          /*!<R/W 0  //10: iq=1uA; load=0.01mA~3mA //01: iq=100uA; load=2mA~50mA //00: iq=1.5mA; load=30mA~160mA */
...
#define REGU_MASK_VOADJ_L_3318               ((u32)0x0000000F << 2)          /*!<R/W 1001  // LDO VOSEL // 0000, 0001, 0010, 0011: 1.620, 1.638, 1.657, 1.677 // 0100, 0101, 0110, 0111: 1.697, 1.717, 1.738, 1.760 // 1000, 1001(default), 1010, 1011: 1.782, 1.805, 1.828, 1.851 // 1100, 1101, 1110, 1111: 1.876, 1.901, 1.927, 1.953 */
...
#define REGU_BIT_LDO_3318_DUMMY0             ((u32)0x00000001 << 0)          /*!<R/W 0  Dummy */
/** @} */
 ...
 * @{
 *****************************************************************************/
#define REGU_BIT_VOFB_SEL_SET1               ((u32)0x00000001 << 30)          /*!<R/W 1  1:Feedback from REGU Internal PAD 0:Feedback from External PAD */
...
#define REGU_MASK_REG_STANDBY_L_1209_SLP     ((u32)0x00000003 << 17)          /*!<R/W 10  // LDO standby mode ctrl: // 00 :iq=2mA; load=40mA~410mA // 01: iq=150uA; load=3mA~60mA // 10: iq=1uA; 0.1mA~5mA */
...
/**************************************************************************//**
 * @defgroup AMEBAD_REGU
 * @{
 * @brief AMEBAD_REGU Register Declaration
 *****************************************************************************/
typedef struct {
