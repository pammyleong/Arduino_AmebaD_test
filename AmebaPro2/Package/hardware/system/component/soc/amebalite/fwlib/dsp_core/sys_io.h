...
static inline void sys_bitfield_set_bit(mem_addr_t addr, unsigned int bit)
{
...
static inline void sys_bitfield_clear_bit(mem_addr_t addr, unsigned int bit)
{
	sys_clear_bit(addr + ((bit >> 5) << 2), bit & 0x1F);
}

static inline int sys_bitfield_test_bit(mem_addr_t addr, unsigned int bit)
{
...
static inline int sys_test_and_clear_bit(mem_addr_t addr, unsigned int bit)
{
	int ret;
...
static inline int sys_bitfield_test_and_set_bit(mem_addr_t addr, unsigned int bit)
{
	int ret;
...
static inline int sys_bitfield_test_and_clear_bit(mem_addr_t addr, unsigned int bit)
{
	int ret;
