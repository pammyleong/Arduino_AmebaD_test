...
#define CTRL_MASK_GRP_x_PWR_LPS                   ((u32)0x00000007 << 12)          /*!<R/W 3'b010  Reserved for grp_x_pwr_lps for memory groups power controlled by SYSPMC. Used to controll power mode of this memory group when chip is SLEEP. For FTC_ULP mem, pwr_lps[2:0] map to {SLP,RET,NAP}; For SNPS mem, pwr_lps[2:0] map to {SD,DS,LS}. 000 - active 001 - light sleep 010 - deep sleep 100 - shut down */
...
/** @defgroup MEM_CTRL_LPS_define
  * @{
  */
#define BIT_MEM_CTRL_LPS_ACTIVE		0x000
#define BIT_MEM_CTRL_LPS_LS			0x001
#define BIT_MEM_CTRL_LPS_DS			0x010
#define BIT_MEM_CTRL_LPS_SD			0x100
