...
#define PMC_BIT_PST_SLEP_LDOM             ((u32)0x00000001 << 9)          /*!<R/W 0  Sleep setting for core LDO mode selection 1: core LDO keeps at normal mode when PMC enter into sleep mode 0: core switch to standby mode when PMC enter into sleep mode */
