...
/**************************************************************************//**
 * @defgroup AMEBALITE_IPC
 * @{
 * @brief AMEBALITE_IPC Register Declaration
 *****************************************************************************/
typedef struct {
...
/** @defgroup IPC_VALID_PXID_definitions
  * @{
  */
...
/* Channel Definitions --------------------------------------------------------*/
/**************************************************************************//**
 * @defgroup IPC_KR4_TX_Channel_Definitions IPC Channel Definitions
 * @{
 *****************************************************************************/
...
/* Channel Definitions --------------------------------------------------------*/
/**************************************************************************//**
 * @defgroup IPC_KM4_TX_Channel_Definitions IPC Channel Definitions
 * @{
 *****************************************************************************/
#define IPC_M2R_TICKLESS_INDICATION				0	/*!<  KM4 -->  KR4 Tickless indicate */
#define IPC_M2R_WIFI_FW_INFO						1	/*!<  KM4 -->  KR4 FW Info*/
#define IPC_M2R_FLASHPG_REQ						2	/*!<  KM4 -->  KR4 Flash Program Request*/
...
#define IPC_M2R_WIFI_TRX_TRAN						6	/*!<  AP -->  NP WIFI Message Exchange */
#define IPC_M2R_WIFI_API_TRAN						7	/*!<  AP -->  NP WIFI API Message Exchange */


#define IPC_M2D_WIFI_TRX_TRAN						0	/*!<  KM4 -->  DSP WIFI Message Exchange */
#define IPC_M2D_WIFI_API_TRAN						1	/*!<  KM4 -->  DSP API WIFI Message Exchange */
...
/* Channel Definitions --------------------------------------------------------*/
/**************************************************************************//**
 * @defgroup IPC_DSP_TX_Channel_Definitions IPC Channel Definitions
 * @{
 *****************************************************************************/
