...
/**************************************************************************//**
 * @defgroup AMEBAD2_COMP
 * @{
 * @brief AMEBAD2_COMP Register Declaration
 *****************************************************************************/
typedef struct {
...
/** @defgroup COMP_Interrupt_Definitions
  * @{
  */
...
/** @defgroup COMP_ZCD_Src_Selection
  * @{
  */
...
/** @defgroup COMP_Debounce_Cnt_Definitions
  * @{
  */
