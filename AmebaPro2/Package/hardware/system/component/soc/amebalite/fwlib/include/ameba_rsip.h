...
/**************************************************************************//**
 * @defgroup AMEBAD2_RSIP
 * @{
 * @brief AMEBAD2_RSIP Register Declaration
 *****************************************************************************/
typedef struct {
	...
	RSIP_MMU_TypeDef FLASH_MMU[8];                        /*!< RSIP IP have 4 ports,  Address offset: 0x100-0x12C */
} RSIP_REG_TypeDef;
/** @} */
/* AUTO_GEN_END */
