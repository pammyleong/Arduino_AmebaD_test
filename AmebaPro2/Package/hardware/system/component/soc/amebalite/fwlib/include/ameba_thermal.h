...
/**************************************************************************//**
 * @defgroup AMEBALITE_THERMAL
 * @{
 * @brief AMEBALITE_THERMAL Register Declaration
 *****************************************************************************/
typedef struct {
...
typedef struct {
	u8 TM_DownSampRate;			/*!< Specifies thermal decimation filter down sample rate.
									This parameter can be a value of @ref TM_Down_Sample_Rate_Definitions */

	u8 TM_AdcClkDiv;				/*!< Specifies thermal ADC clock divider.
									This parameter can be a value of @ref TM_ADC_CLK_Divider_Definitions */
...
/** @defgroup TM_Programme_Password_Definitions
  * @{
  */
...
/** @defgroup TM_Down_Sample_Rate_Definitions
  * @{
  */
...
/** @defgroup TM_ADC_CLK_Divider_Definitions
  * @{
  */
