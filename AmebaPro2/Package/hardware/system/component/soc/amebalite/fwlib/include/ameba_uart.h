...
/**************************************************************************//**
 * @defgroup AMEBADLITE_UART
 * @{
 * @brief AMEBADLITE_UART Register Declaration
 *****************************************************************************/
typedef struct {
...
/** @defgroup UART_FIFO_Size_define for UART0/1/2
  * @{
  */
...
/** @defgroup UART_FIFO_Size_define for UART3_BT
  * @{
  */
...
/** @defgroup UART_External_functions
  * @{
  */
