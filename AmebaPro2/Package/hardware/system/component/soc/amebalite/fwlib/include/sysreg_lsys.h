...
#define LSYS_MASK_CKD_KR4                          ((u32)0x0000000F << 4)          /*!<R/WPD 1h  KR4 clock divider, it is based on cpu/dsp pll 0: div1 1: div2 2: div3 3/other: divider by this value + 1 */
#define LSYS_CKD_KR4(x)                            ((u32)(((x) & 0x0000000F) << 4))
#define LSYS_GET_CKD_KR4(x)                        ((u32)(((x >> 4) & 0x0000000F)))
#define LSYS_MASK_CKD_KM4                          ((u32)0x0000000F << 0)          /*!<R/WPD 1h  KM4 clock divider, it is based on cpu/dsp pll 0: div1 1: div2 2: div3 3/other: divider by this value + 1 */
