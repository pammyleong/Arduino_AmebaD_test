...
#define AON_BIT_GPIOB_RSTB                 ((u32)0x00000001 << 17)          /*!<R/W 1  1: Enable GPIOB group pad 0: Reset PAD This is for audio pad, may not use */
#define AON_BIT_GPIOA_RSTB                 ((u32)0x00000001 << 16)          /*!<R/W 1  1: Enable GPIOA group pad 0: Reset PAD */
...
#define AON_BIT_GPIOB_SHDN                 ((u32)0x00000001 << 9)          /*!<R/W 1  1: Enable GPIOB group pad 0: Shutdown PAD This is for audio pad, may not use */
#define AON_BIT_GPIOA_SHDN                 ((u32)0x00000001 << 8)          /*!<R/W 1  1: Enable GPIOA group pad 0: Shutdown PAD */
...
#define AON_BIT_PWC_AON_OTP                ((u32)0x00000001 << 1)          /*!<R/W 0  OTP power cut enable for core/IO power, high active. 1:enable 0:disable */
/** @} */
