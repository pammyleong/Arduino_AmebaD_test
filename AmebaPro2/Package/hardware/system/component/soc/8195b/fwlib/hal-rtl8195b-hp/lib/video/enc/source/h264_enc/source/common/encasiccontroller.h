...
enum
{
    ...
    ASIC_PENALTY_I16FAVOR,				// update every frame step 1
    ASIC_PENALTY_I4_PREV_MODE_FAVOR,	// update every frame step 2
    ASIC_PENALTY_COST_INTER,
    ASIC_PENALTY_DMV_COST_CONST,
    ASIC_PENALTY_INTER_FAVOR,			// update every frame step 3
    ASIC_PENALTY_SKIP,					// update every frame step 4
    ASIC_PENALTY_GOLDEN,				// update every frame step 8
    ASIC_PENALTY_SPLIT4x4,
    ASIC_PENALTY_SPLIT8x4,
    ASIC_PENALTY_SPLIT8x8,
    ASIC_PENALTY_SPLIT16x8,
    ASIC_PENALTY_SPLIT_ZERO,
    ASIC_PENALTY_DMV_4P,				// update every frame step 5
    ASIC_PENALTY_DMV_1P,				// update every frame step 6
    ASIC_PENALTY_DMV_QP,				// update every frame step 7
    ASIC_PENALTY_DZ_RATE0,				// NA
    ASIC_PENALTY_DZ_RATE1,				// NA
    ASIC_PENALTY_DZ_RATE2,				// NA
    ASIC_PENALTY_DZ_RATE3,				// NA
    ASIC_PENALTY_DZ_SKIP0,				// NA
    ASIC_PENALTY_DZ_SKIP1,				// NA
...
typedef struct
{
	...
	u32 *regMirror;
//	u32 *regMirror_voe;
//	u32 regMirror_hs[ASIC_SWREG_AMOUNT];
...
void EncAsicFrameEnc(const void *ewl, regValues_s * val);

void JPEG_EncAsicFrameInit(const void *ewl, regValues_s * val);
void JPEG_EncAsicFrameStart(const void *ewl, regValues_s * val);
