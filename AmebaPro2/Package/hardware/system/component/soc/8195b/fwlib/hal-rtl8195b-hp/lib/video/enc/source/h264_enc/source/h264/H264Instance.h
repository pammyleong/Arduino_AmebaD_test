...
typedef struct
{
    ...
    i32 gdrForceIntraFrame;	// Ameba GDR mode force output IDR Added By Raymond

    inputLineBuf_s inputLineBuf;
    i32 rfcBufOverflow;

	u32 outBufSize;		//Size of output stream buffer in bytes Added By Raymond
    ...
    u32 idr_size;		// Ameba IDR Header size Added By Raymond
//	long index;			// modify from struct h264_context Added By Raymond

	H264EncPictureCodingType codingType;	// For VOE use Added By Raymond
