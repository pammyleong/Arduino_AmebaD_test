 ...
 *
 * @file     rtl8195blp_aon.h
 * @brief    CMSIS HeaderFile
 * @version  1.0
 * @date     23. May 2019
 * @note     Generated by SVDConv V3.3.18 on Thursday, 23.05.2019 16:23:43
 *           from File 'rtl8195b-lp-aon.svd',
 *           last modified on Thursday, 23.05.2019 08:23:39
 */


/** 
 * @addtogroup ls_hal_aon AON
 * @ingroup 8195bl_hal
 * @{
 * @brief The (Power) Always On Domain Control Registers.
 */


#ifndef RTL8195BLP_AON_H
#define RTL8195BLP_AON_H

#ifdef __cplusplus
extern "C" {
#endif

/// @cond DOXYGEN_AON_REG_TYPE
...
/** @addtogroup device_aon_reg AON Registers Type
  * @ingroup ls_hal_aon
  * @{
  */
...
/**
  * @brief LS Always On Domain Control (AON)
  */

typedef struct {                                /*!< (@ 0xA0000000) AON Structure                                              */
  __IM  uint32_t  RESERVED;
  
  union {
    __IOM uint32_t iso_ctrl;                    /*!< (@ 0x00000004) Isolation Control Register                                 */
  ...
  union {
    __IOM uint32_t sw_reserv0;                  /*!< (@ 0x0000000C) SW Reserved Register                                       */
  ...
  union {
    __IOM uint32_t ldo_ctrl0;                   /*!< (@ 0x00000010) LDO Control Register0                                      */
  ...
  union {
    __IOM uint32_t ldo_ctrl1;                   /*!< (@ 0x00000014) LDO Control Register1                                      */
  ...
  union {
    __IOM uint32_t mem_pwr_ctrl;                /*!< (@ 0x0000001C) Memory Power (Deep Sleep) Control Register                 */
  ...
  union {
    __IOM uint32_t xtal_32k_ctrl0;              /*!< (@ 0x00000020) 32K Xtal Control Register0                                 */
  ...
  union {
    __IOM uint32_t xtal_32k_ctrl1;              /*!< (@ 0x00000024) 32K Xtal Control Register1                                 */
  ...
  union {
    __IOM uint32_t fast_boot_ctrl;              /*!< (@ 0x00000028) Fast Boot Control register                                 */
  ...
  union {
    __IOM uint32_t osc_32k_ctrl;                /*!< (@ 0x0000002C) 32K Oscillator Control Register                            */
  ...
  union {
    __IOM uint32_t wake_tmr;                    /*!< (@ 0x00000030) AON Wake Up Timer Register                                 */
  ...
  union {
    __IOM uint32_t io_pad_ctrl;                 /*!< (@ 0x00000038) AON IO Pad Control Register                                */
  ...
  union {
    __IOM uint32_t gpio_wake_ctrl;              /*!< (@ 0x0000003C) AON GPIO Wake Up Control Register                          */
  ...
  union {
    __IOM uint32_t charg_ctrl0;                 /*!< (@ 0x00000040) Battery Charger Control Register0                          */
  ...
  union {
    __IOM uint32_t charg_ctrl12;                /*!< (@ 0x00000044) Battery Charger Control Register12                         */
  ...
  union {
    __IOM uint32_t charg_ctrl34;                /*!< (@ 0x00000048) Battery Charger Control Register34                         */
  ...
  union {
    __IOM uint32_t charg_ctrl56;                /*!< (@ 0x0000004C) Battery Charger Control Register56                         */
  ...
  union {
    __IOM uint32_t pmc_ctrl;                    /*!< (@ 0x00000050) Power Management Control Register                          */
  ...
  union {
    __IOM uint32_t pm_opt;                      /*!< (@ 0x00000054) Power Management Optional Control Register                 */
  ...
  union {
    __IOM uint32_t wake_opt_msk;                /*!< (@ 0x00000058) AON Wake Option Mask Register                              */
  ...
  union {
    __IOM uint32_t wake_opt_sts;                /*!< (@ 0x0000005C) AON Wake Status Register                                   */
  ...
  union {
    __IOM uint32_t lsfif_cmd;                   /*!< (@ 0x00000080) Low Speed Function Interface Command Register              */
  ...
  union {
    __IOM uint32_t lsfif_rwd;                   /*!< (@ 0x00000084) Low Speed Function Interface R/W Data Register             */
  ...
  union {
    __IOM uint32_t rtc_imr;                     /*!< (@ 0x00000088) RTC Interrupt Mask Register                                */
  ...
  union {
    __IOM uint32_t rtc_isr;                     /*!< (@ 0x0000008C) RTC Interrupt Status Register                              */
...
} AON_Type;                                     /*!< Size = 144 (0x90)                                                         */


/** @} */ /* End of group device_aon_reg */
...
/** @addtogroup device_aon_addr AON Registers Base Address
  * @ingroup ls_hal_aon
  * @{
  */

#define AON_BASE                    0xA0000000UL

/** @} */ /* End of group device_aon_addr */
...
/** @addtogroup device_aon_decl AON Registers Declaration
  * @ingroup ls_hal_aon
  * @{
  */
...
#include "rtl8195blp_aon_type.h"

/// @endcond /* End of condition DOXYGEN_AON_REG_TYPE */

#ifdef __cplusplus
}
#endif

#endif /* RTL8195BLP_AON_H */


/** @} */ /* End of group ls_hal_aon */
