...
#define USB_OTG_ADDON_REG_CTRL_BIT_UPLL_CKRDY			BIT(5)  /* R/W  0       1: USB PHY clock ready */
#define USB_OTG_ADDON_REG_CTRL_BIT_USBOTG_EN			BIT(8)  /* R/W  0       1: Enable USB OTG */
#define USB_OTG_ADDON_REG_CTRL_BIT_USBPHY_EN			BIT(9)  /* R/W  0       1: Enable USB APHY & DPHY */
#define USB_OTG_ADDON_REG_CTRL_BIT_PORETB_TOP			BIT(14) /* R/W  0       1: Enable USB APHY */
...
typedef struct {
	...
	uint32_t Reserved30;                /*!< Reserved                                     030h */
	__IO uint32_t GPVNDCTL;             /*!< Reserved                                     034h */
	uint32_t Reserved38;                /*!< Reserved                                     038h */
	__IO uint32_t GUID;                 /*!< User ID Register                             03Ch */
	__IO uint32_t GSNPSID;              /*!< Synopsys ID Register                         040h */
	__IO uint32_t GHWCFG1;              /*!< User HW Config1 Register                     044h */
	__IO uint32_t GHWCFG2;              /*!< User HW Config2 Register                     048h */
	__IO uint32_t GHWCFG3;              /*!< User HW Config3 Register                     04Ch */
	__IO uint32_t GHWCFG4;              /*!< User HW Config4 Register                     050h */
	__IO uint32_t GLPMCFG;              /*!< LPM Register                                 054h */
	__IO uint32_t GPWRDN;               /*!< Reserved                                     058h */
	uint32_t  Reserved5C[41];           /*!< Reserved                                05Ch-0FFh */
...
typedef struct {
	...
	__IO uint32_t DTKNQR1;         /*!< Device IN Token Sequence Learning Queue Read Register 1  820h */
	__IO uint32_t DTKNQR2;         /*!< Device IN Token Sequence Learning Queue Read Register 2  824h */
	__IO uint32_t DVBUSDIS;        /*!< dev VBUS discharge Register  828h */
	__IO uint32_t DVBUSPULSE;      /*!< dev VBUS Pulse Register      82Ch */
	__IO uint32_t DTKNQR3;         /*!< Device IN Token Sequence Learning Queue Read Register 3  830h */
	__IO uint32_t DTKNQR4;         /*!< Device IN Token Sequence Learning Queue Read Register 4  834h */
	uint32_t Reserved38[2];        /*!< Reserved                     838h-83Ch */
...
typedef struct {
	...
	__IO uint32_t DIEPDMAB;          /*!< IN Endpoint-n DMA Buffer Address Register (n=0..15) 900h+ (ep_num * 20h) + 1Ch */
...
typedef struct {
	...
	__IO uint32_t DOEPDMAB;      /*!< Device Endpoint-n DMA Buffer Address Register B00h + (ep_num * 20h) + 1Ch */
