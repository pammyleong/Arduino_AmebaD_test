...
/**
 * @brief SDIOH_HOST Register Declaration
 */
typedef struct {
...
/** @defgroup SDIOH_Mode_Definitions
  * @{
  */
...
/** @defgroup SDIOH_Timeout_Definitions
  * @{
  */
...
/** @defgroup SDIOH_CMD_Value_Definitions
  * @{
  */
...
/** @defgroup SDIOH_Specific_Data_Length
  * @{
  */
...
/** @defgroup SDIOH_Card_Response_Byte_Index
  * @{
  */
#define SDIO_RESP0						0
#define SDIO_RESP1						1
...
/** @defgroup SDIOH_Testchip_Workaround
  * @{
  */
