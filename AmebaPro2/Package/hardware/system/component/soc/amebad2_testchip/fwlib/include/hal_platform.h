...
#define TIMER9_REG_BASE          0x4100A800        /* ID:HSLV9-10, Inter. Type:APB4, Top Address:0x4100AFFF, Size(KB):4K, Clk Domain:HS_APB_CLK */
...
#define CA7_ROM_BASE             0x00000000        /* ID:HSLAV10, Inter. Type:AXI-128, Top Address:0x000003FF, Size(KB):1K, Clk Domain:HS_AXI_CLK */
#define CA7_DBG_REG_BASE         0xA0000000        /* ID:HSLAV12-0, Inter. Type:APB, Top Address:0xA003FFFF, Size(KB):256K, Clk Domain:HS_APB_CLK */
#define CA7_TIMESTAMP_BASE       0xB0002000        /* ID:HSLAV12-1, Inter. Type:APB, Top Address:0xB0002FFF, Size(KB):4K, Clk Domain:HS_APB_CLK */
...
#define TIMER9_REG_BASE_S        0x5100A800        /* ID:HSLV9-10, Inter. Type:APB4, Top Address:0x4100AFFF, Size(KB):4K, Clk Domain:HS_APB_CLK */
...
#define CA7_ROM_BASE_S           0x10000000        /* ID:HSLAV10, Inter. Type:AXI-128, Top Address:0x000003FF, Size(KB):1K, Clk Domain:HS_AXI_CLK */
#define CA7_DBG_REG_BASE_S       0xB0000000        /* ID:HSLAV12-0, Inter. Type:APB, Top Address:0xA003FFFF, Size(KB):256K, Clk Domain:HS_APB_CLK */
#define CA7_TIMESTAMP_BASE_S     0xC0002000        /* ID:HSLAV12-1, Inter. Type:APB, Top Address:0xB0002FFF, Size(KB):4K, Clk Domain:HS_APB_CLK */
 ...
 *****************************************************************************/
typedef struct {
	__IO uint32_t PADCTR[71];			/*!< Pad control register */
} PINMUX_TypeDef;
/** @} */
