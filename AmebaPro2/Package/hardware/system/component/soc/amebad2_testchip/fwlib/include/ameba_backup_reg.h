...
/* Exported types --------------------------------------------------------*/
/** @defgroup BKUP_REG_Exported_Types BKUP_REG Exported Types
  * @{
  */

/**
 * @brief BACKUP_REG Register Declaration
 * @note 16 Bytes in total.
 */
typedef struct {
...
#define BKUP_REG2				((u32)0x00000002)	/*!< all bits used by system, but can be used after bootloader */
