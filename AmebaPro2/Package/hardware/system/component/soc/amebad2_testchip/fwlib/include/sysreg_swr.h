...
typedef struct {
	...
	__IO uint32_t RSVD4[21];                              /*!<  Reserved,  Address offset:0x3C-0x8C */
	__IO uint32_t SWR_NEW;                                /*!<  Register,  Address offset: 0x090 */
} SWR_TypeDef;
...
/** @defgroup SWR_VOL SWR voltage mode
  * @{
  */
#define SWR_VOL_LPS							((u32)0x00000000)
#define SWR_VOL_NM							((u32)0x00000001)
#define SWR_VOL_BST							((u32)0x00000002)

#define IS_SWR_VOL_MODE(MODE) (((MODE) == SWR_VOL_LPS) || \
										((MODE) == SWR_VOL_NM) || \
										((MODE) == SWR_VOL_BST))
/**
  * @}
...
/** @defgroup SWR_Exported_Functions SWR Exported Functions
  * @{
  */
_LONG_CALL_ u32 SWR_CORE_Mode_Get(void);
_LONG_CALL_ u32 SWR_CORE_Mode_Set(u32 SWR_Mode);
_LONG_CALL_ u32 SWR_CORE_Vol_Get(void);
_LONG_CALL_ u32 SWR_CORE_Vol_Set(u32 SWR_Vol, u32 VOL_Value);
_LONG_CALL_ u32 SWR_MEM(u32 NewState);
_LONG_CALL_ u32 SWR_MEM_Mode_Get(void);
_LONG_CALL_ u32 SWR_MEM_Mode_Set(u32 SWR_Mode);
_LONG_CALL_ u32 SWR_PSRAM(u32 NewState);
