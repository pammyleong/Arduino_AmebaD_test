...
#define TRNG_MASK_BUFFER_ENTRY_LEVEL              ((u32)0x0000000F << 0)          /*!<RO   Number of 32-bit random number are valid. 0 is empty, and 8 is full. */
 ...
 * @{
 **/
#define TRNG_MASK_RCT_CUTOFF_VALUE                ((u32)0x000000FF << 8)          /*!<R/W 0x1F  Cutoff value */
#define TRNG_RCT_CUTOFF_VALUE(x)                  ((u32)(((x) & 0x000000FF) << 8))
#define TRNG_GET_RCT_CUTOFF_VALUE(x)              ((u32)(((x >> 8) & 0x000000FF)))
#define TRNG_MASK_RCT_SAMPLE_SIZE                 ((u32)0x00000007 << 1)          /*!<R/W 0x0  Number of bit per test sample. The sample size is the value add 1. 0: 1-bit 1: 2-bit ... 7: 8-bit */
#define TRNG_RCT_SAMPLE_SIZE(x)                   ((u32)(((x) & 0x00000007) << 1))
#define TRNG_GET_RCT_SAMPLE_SIZE(x)               ((u32)(((x >> 1) & 0x00000007)))
#define TRNG_BIT_RCT_ENABLE                       ((u32)0x00000001 << 0)          /*!<R/W 0x1  Test enable */
/** @} */
 ...
 * @{
 **/
#define TRNG_MASK_RCT_CUTOFF_VALUE                ((u32)0x000000FF << 8)          /*!<R/W 0x5  Cutoff value */
#define TRNG_RCT_CUTOFF_VALUE(x)                  ((u32)(((x) & 0x000000FF) << 8))
#define TRNG_GET_RCT_CUTOFF_VALUE(x)              ((u32)(((x >> 8) & 0x000000FF)))
#define TRNG_MASK_RCT_SAMPLE_SIZE                 ((u32)0x00000007 << 1)          /*!<R/W 0x7  Number of bit per test sample. The sample size is the value add 1. 0: 1-bit 1: 2-bit ... 7: 8-bit */
#define TRNG_RCT_SAMPLE_SIZE(x)                   ((u32)(((x) & 0x00000007) << 1))
#define TRNG_GET_RCT_SAMPLE_SIZE(x)               ((u32)(((x >> 1) & 0x00000007)))
#define TRNG_BIT_RCT_ENABLE                       ((u32)0x00000001 << 0)          /*!<R/W 0x1  Test enable */
/** @} */
...
typedef struct {
	...
	__IO uint32_t TRNG_SW_RESET;                          /*!<  Register,  Address offset: 0x038 */
	...
	__IO uint32_t TRNG_ROSC_CAL_CTRL;                     /*!<  Register,  Address offset: 0x1A8 */
} TRNG_TypeDef;
/** @} */
/* AUTO_GEN_END */
