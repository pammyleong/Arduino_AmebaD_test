 ...
 * @{
 **/
#define PSPHY_MASK_DQ_CTRL_PSRAM               ((u32)0x07FFFFFF << 0)          /*!<R/W 0   */
 ...
 * @{
 **/
#define PSPHY_MASK_DQS_N_CTRL_PSRAM            ((u32)0x00000FFF << 0)          /*!<R/W 0   */
 ...
 * @{
 **/
#define PSPHY_MASK_DQS_P_CTRL_PSRAM            ((u32)0x0FFFFFFF << 0)          /*!<R/W 0   */
 ...
 * @{
 **/
#define PSPHY_MASK_VREF_S_0_PSRAM              ((u32)0x0000003F << 16)          /*!<R/W 0   */
...
#define PSPHY_BIT_REG_VREF_RANGE_SET_0_PSRAM   ((u32)0x00000001 << 6)          /*!<R/W 0   */
...
/**
 * @brief AMEBAD2_PSPHY Register Declaration
 *****************************************************************************/
typedef struct {
