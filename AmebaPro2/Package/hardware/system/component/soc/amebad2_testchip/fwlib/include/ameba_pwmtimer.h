 ...
 * @{
 **/
#define TIM_BIT_ETP         ((u32)0x00000001 << 8)          /*!<R/W 0x0  external trigger polarity(TRGI) * 0: positive edge is active * 1: negative edge is active Note: this bit is only valid in one-pulse mode. */
...
#define TIM_BIT_UIE         ((u32)0x00000001 << 0)          /*!<R/W 0x0  enable update interrupt */
/** @} */
...
#define IS_TIM_IT(IT) ((((IT) & (u32)0xFFFFFF80) == 0x0000) && (((IT) & (u32)0x7F) != 0x0000))
...
extern int TIMx_irq[10];
extern RTIM_TypeDef *TIMx[10];
