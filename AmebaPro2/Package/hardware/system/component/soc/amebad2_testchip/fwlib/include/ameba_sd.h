...
/* Exported types --------------------------------------------------------*/
/** @addtogroup SDIOH_Exported_Types SDIOH Exported Types
  * @{
  */
...
/** @brief SDIOH CFG Structure Definition
  */
typedef struct {
...
/* Exported constants --------------------------------------------------------*/
/** @addtogroup SDIOH_Exported_Constants SDIOH Exported Constants
  * @{
  */
...
/* Exported functions --------------------------------------------------------*/
/** @addtogroup SDIOH_Exported_Functions SDIOH Exported Functions
  * @{
  */
