...
#define BIT_TSF_CK_SLP_SEL				((u32)(0x00000001 << 8)) /*<1: TSF clock switch to 32.768KHz; 0: TSF clock switch to MAC clock*/

/* REG_WL_PMC_CTRL 0x0020 */
#define BIT_CUR_PST_ISLPS				((u32)(0x00000001 << 4)) /*<indicate current WL power status is LPS mode*/
#define BIT_WL_PMC_LPSEN				((u32)(0x00000001 << 2)) /*!<Inform WLAN PMC FSM to enter LPS mode. (auto clear when ready)*/
#define BIT_WL_PMC_OFFMAC				((u32)(0x00000001 << 1)) /*!< Auto FSM to Turn On, include clock, isolation, power control for MAC only														(auto set by ICFG, and clear when Power Ready) */
#define BIT_WL_APMC_ONMAC			((u32)(0x00000001 << 0)) /*!< Auto FSM to Turn On, include clock, isolation, power control for MAC only */
...
/* REG_TSF_CLK_STATE 0x108 */
#define BIT_CLK_TSF_IS_32K				((u32)0x00000001 << 15) /*<Which Clock is Used by TSF Clock 1: 32K Clock 0: MAC Clock*/
