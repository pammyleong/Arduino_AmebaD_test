 ...
 * @{
 **/
#define MASK_SCKDV                 ((u32)0x00000FFF << 0)          /*!<R/W Check SPIC frequency in configure form * *: (spic frequency) / 32 ex: spic freq=120 MHz, SCKDV= âŒ?120/32âŒ? = âŒ?3.75âŒ? =3  Define spi_sclk divider value. The frequency of spi_sclk = The frequency of bus_clk / (2*SCKDV). */
...
/** @defgroup FLASH_Clk_Div_Definitions
  * @{
  */
#define FLASH_CLK_DIV3P0		0
#define FLASH_CLK_DIV4P0		1
#define FLASH_CLK_DIV5P0		2
#define FLASH_CLK_DIV6P0		3
/**
  * @}
  */
