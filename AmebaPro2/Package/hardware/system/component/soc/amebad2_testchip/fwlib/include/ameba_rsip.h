...
/** @defgroup RSIP_MOR
 * @brief Maintenance Operation Rregister
 * @{
 **/
...
/** @defgroup RSIP_GCM_Tag_base_address_register
 * @brief
 * @{
 **/
 ...
 * @{
 **/
#define RSIP_MASK_REGION_x_BASE       ((u32)0x000FFFFF << 12)          /*!<R/W 0x0  Region x base address register. */
#define RSIP_REGION_x_BASE(x)         ((u32)(((x) & 0x000FFFFF) << 12))
#define RSIP_GET_REGION_x_BASE(x)     ((u32)(((x >> 12) & 0x000FFFFF)))
/** @} */
 ...
 * @{
 **/
#define RSIP_MASK_REGION_x_END        ((u32)0x000FFFFF << 12)          /*!<R/W 0x0  Region x end address register. */
#define RSIP_REGION_x_END(x)          ((u32)(((x) & 0x000FFFFF) << 12))
#define RSIP_GET_REGION_x_END(x)      ((u32)(((x >> 12) & 0x000FFFFF)))
#define RSIP_MASK_REGION_x_IV_NUM     ((u32)0x00000007 << 8)          /*!<R/W 0x0  IV used in region x Apply which IV reigster to this region Number corresponds to IV register */
#define RSIP_REGION_x_IV_NUM(x)       ((u32)(((x) & 0x00000007) << 8))
#define RSIP_GET_REGION_x_IV_NUM(x)   ((u32)(((x >> 8) & 0x00000007)))
...
/** @defgroup RSIP_Remap_x_region_address_register
 * @brief
 * @{
 **/
#define RSIP_MASK_REMAP_BASE_x_ADDR   ((u32)0x0000FFFF << 16)          /*!<R/W 0x0  Remap region x base address [27:12] Region_Base_Addr = {flash_base[31:28], remap_base_x_addr, 12'b0} The region address is 4KB aligned, and not cross 256KB */
#define RSIP_REMAP_BASE_x_ADDR(x)     ((u32)(((x) & 0x0000FFFF) << 16))
#define RSIP_GET_REMAP_BASE_x_ADDR(x) ((u32)(((x >> 16) & 0x0000FFFF)))
#define RSIP_MASK_REMAP_END_x_ADDR    ((u32)0x0000FFFF << 0)          /*!<R/W 0x0  Remap region x end address [27:12] Region_End_Addr = {flash_base[31:28], remap_end_x_addr, 12'b0} The region address is 4KB aligned, and not cross 256KB */
#define RSIP_REMAP_END_x_ADDR(x)      ((u32)(((x) & 0x0000FFFF) << 0))
#define RSIP_GET_REMAP_END_x_ADDR(x)  ((u32)(((x >> 0) & 0x0000FFFF)))
/** @} */

/** @defgroup RSIP_Remap_x_offset_register
 * @brief
 * @{
 **/
#define RSIP_MASK_REMAP_x_OFFSET      ((u32)0x0000FFFF << 16)          /*!<R/W 0x0  Remap region x offset [27:12] Region_Offset = {4'b0,remap_x_offset, 12'b0} The output address is "Access address - Region_Base_Addr + Region_Offset" */
#define RSIP_REMAP_x_OFFSET(x)        ((u32)(((x) & 0x0000FFFF) << 16))
#define RSIP_GET_REMAP_x_OFFSET(x)    ((u32)(((x >> 16) & 0x0000FFFF)))
...
typedef struct {
	...
	__IO uint32_t RSIP_RxSR;                              /*!< REGION x SETTING REGISTER */
} OTF_Region_TypeDef;
...
typedef struct {
	...
	__IO uint32_t RSIP_IV_x_BIT_HIGH;                     /*!< Register */
	__IO uint32_t RSIP_IV_x_BIT_LOW;                      /*!< Register */
} OTF_IV_TypeDef;
...
typedef struct {
	...
	__IO uint32_t RSIP_REMAP_x_REGION_ADDRESS_REGISTER;   /*!< Register */
	__IO uint32_t RSIP_REMAP_x_OFFSET_REGISTER;           /*!< Register */
} RSIP_MMU_TypeDef;
...
typedef struct {
	...
	__O  uint32_t RSIP_MOR;                               /*!< MAINTENANCE OPERATION RREGISTER,  Address offset: 0x18 */
	__O  uint32_t RSIP_LR;                                /*!< LOCK REGISTER,  Address offset: 0x1C */
	__IO uint32_t RSIP_GCM_TAG_BASE_ADDRESS_REGISTER;     /*!<  Register,  Address offset: 0x20 */
	__IO uint32_t RSVD1[7];                               /*!<  Reserved,  Address offset:0x24-0x3C */
	...
	RSIP_MMU_TypeDef FLASH_MMU[4];                        /*!< RSIP IP have 4 ports,  Address offset: 0x100-0x11C */
} RSIP_REG_TypeDef;
/** @} */
/* AUTO_GEN_END */
...
/** @defgroup RSIP_Addr_Mask_Definitions
  * @{
  */
#define MMU_ADDR_BIT_MASK			((u32)0x0FFFF000)			/*!<Decoder mask enable for MMU address */
#define OTF_ADDR_BIT_MASK			((u32)0xFFFFF000)			/*!<Decoder mask enable for OTF address */
/**
  * @}
  */
