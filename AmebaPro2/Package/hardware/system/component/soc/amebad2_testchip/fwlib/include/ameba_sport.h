...
/** @defgroup SP_word_length AUDIO_SPORT Word Length
  * @{
  */
...
/** @defgroup SP_data_format AUDIO_SPORT Interface Format
  * @{
  */
...
/** @defgroup SP_channel_number AUDIO_SPORT Channel Number
  * @{
  */
...
/** @defgroup SP_SEL_RX_channel AUDIO_SPORT Selection of RX Channel
  * @{
  */
...
/** @defgroup SP_SEL_TX_channel AUDIO_SPORT Selection of TX Channel
  * @{
  */
...
/** @defgroup SP_SEL_Tx_TDMMODE AUDIO_SPORT Selection of TX TDM Mode
  * @{
  */
...
/** @defgroup SP_SEL_RX_TDMMODE AUDIO_SPORT Selection of RX TDM Mode
  * @{
  */
...
/** @defgroup SP_SEL_TX_FIFO AUDIO_SPORT Selection of TX FIFO
  * @{
  */
...
/** @defgroup SP_SEL_RX_FIFO AUDIO_SPORT Selection of RX FIFO
  * @{
  */
...
/** @defgroup SP_TX_channel_length AUDIO_SPORT TX Channel Length
  * @{
  */
...
/** @defgroup SP_RX_channel_length AUDIO_SPORT RX Channel Length
  * @{
  */
...
/** @defgroup SP_SEL_GDMA AUDIO_SPORT Selection of GMDA
  * @{
  */
...
/** @defgroup SP_SetTXMULTIIO AUDIO_SPORT Selection of MultiIO Mode
  * @{
  */
...
/** @defgroup SP_SetRXMULTIIO AUDIO_SPORT Selection of MultiIO Mode
  * @{
  */
...
/** @defgroup SP_application_mode AUDIO_SPORT Application Mode
* @{
*/
...
/** @defgroup SP_SelFixBCLK AUDIO_SPORT Selection of Fix BCLK
* @{
*/
...
/** @defgroup SP_SelI2S AUDIO_SPORT Selection of I2S
* @{
*/
...
/** @defgroup SP_ChnLen AUDIO_SPORT Channel Length
* @{
*/
#define SP_CL_16		(16)
#define SP_CL_20		(20)
...
/** @defgroup SP_SR AUDIO_SPORT Sample Rate
* @{
*/
#define SP_8K			(8)
#define SP_12K			(12)
