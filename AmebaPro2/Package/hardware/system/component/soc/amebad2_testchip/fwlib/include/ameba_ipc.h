 ...
 * @{
 **/
#define IPC_MASK_TX0_DATA               ((u32)0x000000FF << 8)          /*!<R/W/ES 0x0  After prepare descriptor, data and corresponding memory. 1: Write 1 to the TX data register(tx0_data) channel x bit, and the data will be mapped to the AP's RX data register(rx0_data) channel x bit.And corresponding RX full status bit in REG_ISR_AP will be set. 0: write 0 have no effect. If the corresponding RX full status bit in REG_ISR_AP(eg.isr_rx0_full_status6) is cleared, the corresponding bit in tx0_data will be clean automatically. */
#define IPC_TX0_DATA(x)                 ((u32)(((x) & 0x000000FF) << 8))
#define IPC_GET_TX0_DATA(x)             ((u32)(((x >> 8) & 0x000000FF)))
#define IPC_MASK_TX1_DATA               ((u32)0x000000FF << 0)          /*!<R/W/ES 0x0  After prepare descriptor, data and corresponding memory. 1: Write 1 to the TX data register(tx1_data) channel x bit, and the data will be mapped to the NP's RX data register(rx1_data) channel x bit.And corresponding RX full status bit in REG_ISR_NP will be set. 0: write 0 have no effect. If the corresponding RX full status bit in REG_ISR_NP(eg.isr_rx1_full_status6) is cleared, the corresponding bit in tx_data_ln will be clean automatically. */
 ...
 * @{
 **/
#define IPC_MASK_RX0_DATA               ((u32)0x000000FF << 8)          /*!<R 0x0  RX data automatically maps data from tx0_data of AP */
#define IPC_RX0_DATA(x)                 ((u32)(((x) & 0x000000FF) << 8))
#define IPC_GET_RX0_DATA(x)             ((u32)(((x >> 8) & 0x000000FF)))
#define IPC_MASK_RX1_DATA               ((u32)0x000000FF << 0)          /*!<R 0x0  RX data automatically maps data from tx1_data of NP */
 ...
 * @{
 **/
#define IPC_BIT_ISR_RX0_FULL_STATUS7    ((u32)0x00000001 << 31)          /*!<RW1CB 0x0  RX Channel 7 full interrupt status of LP.The corresponding RX full status bit will be set by AP's TX data register(tx0_data) channel 7.It will be cleared by software writing 1. */
...
#define IPC_BIT_ISR_RX1_FULL_STATUS7    ((u32)0x00000001 << 23)          /*!<RW1CB 0x0  RX Channel 7 full interrupt status of LP.The corresponding RX full status bit will be set by NP's TX data register(tx1_data) channel 7.It will be cleared by software writing 1. */
...
#define IPC_BIT_ISR_TX0_EMPTY_STATUS7   ((u32)0x00000001 << 15)          /*!<RW1CB 0x0  TX Channel 7 empty interrupt status of LP transmit to AP.If the corresponding RX full status bit in REG_ISR_AP(eg.isr_rx0_full_status7) is cleared, the corresponding TX empty status bit will be set automatically.It will be cleared by software writing 1. */
...
#define IPC_BIT_ISR_TX1_EMPTY_STATUS7   ((u32)0x00000001 << 7)          /*!<RW1CB 0x0  TX Channel 7 empty interrupt status of LP transmit to NP.If the corresponding RX full status bit in REG_ISR_NP(eg.isr_rx1_full_status7) is cleared, the corresponding TX empty status bit will be set automatically.It will be cleared by software writing 1. */
 ...
 * @{
 **/
#define IPC_MASK_IMR_RX0_FULL_MASK      ((u32)0x000000FF << 24)          /*!<R/W 0x0  0: Mask RX Channel x full interrupt of LP received from AP 1: Unmask RX Channel x full interrupt of LP received from AP */
#define IPC_IMR_RX0_FULL_MASK(x)        ((u32)(((x) & 0x000000FF) << 24))
#define IPC_GET_IMR_RX0_FULL_MASK(x)    ((u32)(((x >> 24) & 0x000000FF)))
#define IPC_MASK_IMR_RX1_FULL_MASK      ((u32)0x000000FF << 16)          /*!<R/W 0x0  0: Mask RX Channel x full interrupt of LP received from NP 1: Unmask RX Channel x full interrupt of LP received from NP */
#define IPC_IMR_RX1_FULL_MASK(x)        ((u32)(((x) & 0x000000FF) << 16))
#define IPC_GET_IMR_RX1_FULL_MASK(x)    ((u32)(((x >> 16) & 0x000000FF)))
#define IPC_MASK_IMR_TX0_EMPTY_MASK     ((u32)0x000000FF << 8)          /*!<R/W 0x0  0: Mask TX Channel x empty interrupt of LP transmit to AP 1: Unmask TX Channel x empty interrupt of LP transmit to AP */
#define IPC_IMR_TX0_EMPTY_MASK(x)       ((u32)(((x) & 0x000000FF) << 8))
#define IPC_GET_IMR_TX0_EMPTY_MASK(x)   ((u32)(((x >> 8) & 0x000000FF)))
#define IPC_MASK_IMR_TX1_EMPTY_MASK     ((u32)0x000000FF << 0)          /*!<R/W 0x0  0: Mask TX Channel x empty interrupt of LP transmit to NP 1: Unmask TX Channel x empty interrupt of LP transmit to NP */
 ...
 * @{
 **/
#define IPC_BIT_ICR_TX0_DATA_CLEAR7     ((u32)0x00000001 << 15)          /*!<RW1CB 0x0  0: write 0 have no effect. 1: Clear the TX data register(tx0_data) channel 7 bit. */
...
#define IPC_BIT_ICR_TX1_DATA_CLEAR7     ((u32)0x00000001 << 7)          /*!<RW1CB 0x0  0: write 0 have no effect. 1: Clear the TX data register(tx1_data) channel 7 bit. */
...
/**
 * @brief IPC IRQ FUN Definition
 */
typedef void (*IPC_IRQ_FUN)(VOID *Data, u32 IrqStatus, u32 ChanNum);

/**
 * @brief IPC Init Table Structure Definition
 */
...
/**
 * @defgroup IPC_LP_TX_Channel_Definitions IPC LP TX Channel Definitions
 * @{
 */
...
/**
 * @defgroup IPC_NP_TX_Channel_Definitions IPC NP TX Channel Definitions
 * @{
 */
...
#define IPC_N2A_FTL_DATA_TRAN					5	/*!<  NP -->  AP API FTL Message Exchange */
...
/**
 * @defgroup IPC_AP_TX_Channel_Definitions IPC AP TX Channel Definitions
 * @{
 */
...
#define IPC_A2N_FTL_ACK_TRAN					2	/*!<  AP -->  NP FTL DONE Message Exchange */
