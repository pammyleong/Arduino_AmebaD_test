...
#define RUART_MASK_DBG_SEL                ((u32)0x0000000F << 8)          /*!<R/W 0x0  Debug port selection */
#define RUART_DBG_SEL(x)                  ((u32)(((x) & 0x0000000F) << 8))
#define RUART_GET_DBG_SEL(x)              ((u32)(((x >> 8) & 0x0000000F)))
 ...
 * @{
 **/
#define RUART_BIT_CLR_DUMMY_FLAG          ((u32)0x00000001 << 24)          /*!<W 0x0  Indicate the clearing of dummy data */
#define RUART_MASK_DUMMY_DATA             ((u32)0x000000FF << 16)          /*!<R/W 0x0  Store dummy data, when UART is DMA flow controller, dummy data is padded for last RXDMA burst request. */
#define RUART_DUMMY_DATA(x)               ((u32)(((x) & 0x000000FF) << 16))
#define RUART_GET_DUMMY_DATA(x)           ((u32)(((x >> 16) & 0x000000FF)))
#define RUART_BIT_RXDMA_OWNER             ((u32)0x00000001 << 15)          /*!<R/W 0x0  * 0: GDMA * 1: UART, interrupt enable signal other than erpd should be masked */
#define RUART_BIT_IRDA_RX_INV             ((u32)0x00000001 << 14)          /*!<R/W 0x0  irda_rx_i reverse input enable */
#define RUART_BIT_IRDA_TX_INV             ((u32)0x00000001 << 13)          /*!<R/W 0x0  irda_tx_o reverse output enable */
#define RUART_MASK_RXDMA_BURSTSIZE        ((u32)0x0000001F << 8)          /*!<R/W 0x4  RXDMA burstsize, maximum value is 16. */
#define RUART_RXDMA_BURSTSIZE(x)          ((u32)(((x) & 0x0000001F) << 8))
#define RUART_GET_RXDMA_BURSTSIZE(x)      ((u32)(((x >> 8) & 0x0000001F)))
#define RUART_MASK_TXDMA_BURSTSIZE        ((u32)0x0000001F << 3)          /*!<R/W 0x4  TXDMA burstsize, maximum value is 16. */
#define RUART_TXDMA_BURSTSIZE(x)          ((u32)(((x) & 0x0000001F) << 3))
#define RUART_GET_TXDMA_BURSTSIZE(x)      ((u32)(((x >> 3) & 0x0000001F)))
...
typedef struct {
	...
	__I  uint32_t DBGR;                                   /*!< UART DEBUG REGISTER,  Address offset: 0x038 */
