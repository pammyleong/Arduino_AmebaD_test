 ...
 * @{
 **/
#define LEDC_MASK_T1H_TIME                 ((u32)0x000000FF << 24)          /*!<R/W 0x1f  LED modulate logical "1" high level time. Unit: cycle (40MHz), T1H_TIME = 25ns * N (N: 1~0x7F) The default value is 800ns, the range is 25ns~3200ns. */
#define LEDC_T1H_TIME(x)                   ((u32)(((x) & 0x000000FF) << 24))
#define LEDC_GET_T1H_TIME(x)               ((u32)(((x >> 24) & 0x000000FF)))
#define LEDC_MASK_T1L_TIME                 ((u32)0x000000FF << 16)          /*!<R/W 0xb  LED modulate logical "1" low level time. Unit: cycle (40MHz), T1H_TIME = 25ns * N (N: 1~0x3F) The default value is 300ns, the range is 25ns~1600ns. */
#define LEDC_T1L_TIME(x)                   ((u32)(((x) & 0x000000FF) << 16))
#define LEDC_GET_T1L_TIME(x)               ((u32)(((x >> 16) & 0x000000FF)))
#define LEDC_MASK_T0H_TIME                 ((u32)0x000000FF << 8)          /*!<R/W 0xb  LED modulate logical "0" hgh level time. Unit: cycle (40MHz), T1H_TIME = 25ns * N (N: 1~0x3F) The default value is 300ns, the range is 25ns~1600ns. */
#define LEDC_T0H_TIME(x)                   ((u32)(((x) & 0x000000FF) << 8))
#define LEDC_GET_T0H_TIME(x)               ((u32)(((x >> 8) & 0x000000FF)))
#define LEDC_MASK_T0L_TIME                 ((u32)0x000000FF << 0)          /*!<R/W 0x1f  LED modulate logical "0" low level time. Unit: cycle (40MHz), T1H_TIME = 25ns * N (N: 1~0x7F) The default value is 800ns, the range is 25ns~3200ns. */
#define LEDC_T0L_TIME(x)                   ((u32)(((x) & 0x000000FF) << 0))
#define LEDC_GET_T0L_TIME(x)               ((u32)(((x >> 0) & 0x000000FF)))
/** @} */
