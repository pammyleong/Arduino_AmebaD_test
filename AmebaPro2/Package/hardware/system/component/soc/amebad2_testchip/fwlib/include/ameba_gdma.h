...
#define BIT_CTLX_UP_BLOCK_BS			((u32)(0x0000FFFF << 0))		/*Upper word Bit[11:0].Block Transfer Size.*/
/** @} */
...
/**
  * @brief  GDMA Channel structure definition
  */
typedef struct {
...
/**
  * @brief  GDMA structure definition
  */
typedef struct {
...
/** @defgroup GDMA_index_channel_definition GDMA Index and Channel Definition
  * @{
  */
...
/** @defgroup GDMA_increment_mode GDMA Source Increment Mode
  * @{
  */
...
/** @defgroup GDMA_interrupts_definition GDMA Interrupt Type
  * @{
  */
...
/** @defgroup GDMA0_HS_Interface_definition GDMA0 HandShake Interface
  * @{
  */
...
/** @defgroup GDMA1_HS_Interface_definition GDMA1 HandShake Interface
  * @{
  */
