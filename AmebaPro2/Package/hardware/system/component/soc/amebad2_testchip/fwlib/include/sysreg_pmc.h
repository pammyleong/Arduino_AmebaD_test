...
#define PMC_BIT_OPT_BKPOFIMK1             ((u32)0x00000001 << 9)          /*!<R/W 0  1: Enable to break PMC power-off flow when receiving wakeup event at pre-define stage1 */
#define PMC_BIT_OPT_BKPOFIMK0             ((u32)0x00000001 << 8)          /*!<R/W 0  1: Enable to break PMC power-off flow when receiving wakeup event at pre-define stage0 */
#define PMC_BIT_PAD_PST_MODE              ((u32)0x00000001 << 4)          /*!<R/W/ES 0  Before shutdown PAD's core power , it must set to 1 to let HW select slp param , then pad will latch the correct value when core power shutdown . When exit dslp , it was default to 0 . 1: HW select pu/pd slp param for PAD 0: HW select pu/pd active param for PAD */
...
#define PMC_MASK_PST_SLEP_FBUS            ((u32)0x00000003 << 14)          /*!<R/W 0x0  Normal setting for ls bus frequency selection 2'b00/01: ANA4M 2'b10: XTAL 2'b11: XTAL/2 */
...
#define PMC_BIT_PST_SLEP_ERCK             ((u32)0x00000001 << 4)          /*!<R/W 0  1: Enable LS SYSON register clock when PMC enter into sleep mode 0: Gate LS SYSON register clock when PMC enter into sleep mode */
...
#define PMC_BIT_PST_SLEP_EACK             ((u32)0x00000001 << 1)          /*!<R/W 0  1: Enable ANA4M CLK when PMC enter into sleep mode 0: Disable ANA4M CLK when PMC enter into sleep mode */
...
#define PMC_BIT_NORM_K0_RAM_SD            ((u32)0x00000001 << 0)          /*!<R/W 0  1: Shut-down CPU RAM when KM0 in active state 0: Power on CPU RAM when KM0 in active state */
/** @} */
...
/** @defgroup PMC_Exported_Types PMC Exported Types
  * @{
*****************************************************************************/


/**
 * @brief AMEBAD2_PMC Register Declaration
 *****************************************************************************/
typedef struct {
	__I  uint32_t WAK_STATUS0;                            /*!<  Register,  Address offset: 0x00 */
	__I  uint32_t WAK_STATUS1;                            /*!<  Register,  Address offset: 0x04 */
	__IO uint32_t WAK_MASK0_LP;                           /*!<  Register,  Address offset: 0x08 */
	__IO uint32_t WAK_MASK1_LP;                           /*!<  Register,  Address offset: 0x0C */
	__IO uint32_t WAK_MASK0_NP;                           /*!<  Register,  Address offset: 0x010 */
	__IO uint32_t WAK_MASK1_NP;                           /*!<  Register,  Address offset: 0x014 */
	__IO uint32_t WAK_MASK0_AP;                           /*!<  Register,  Address offset: 0x018 */
	__IO uint32_t WAK_MASK1_AP;                           /*!<  Register,  Address offset: 0x01C */
	__IO uint32_t WLPMC_ISR;                              /*!<  Register,  Address offset: 0x020 */
	__IO uint32_t WLAN_PWRCTL;                            /*!<  Register,  Address offset: 0x024 */
	__IO uint32_t SYSPMC_CTRL;                            /*!<  Register,  Address offset: 0x028 */
	__IO uint32_t SYSPMC_OPT;                             /*!<  Register,  Address offset: 0x02C */
	__IO uint32_t MEM_PWR_CTRL;                           /*!<  Register,  Address offset: 0x030 */
	__IO uint32_t PMC_PATCH_GRP0_0;                       /*!<  Register,  Address offset: 0x034 */
	__IO uint32_t PMC_PATCH_GRP0_1;                       /*!<  Register,  Address offset: 0x038 */
	__IO uint32_t PMC_PATCH_GRP1_0;                       /*!<  Register,  Address offset: 0x03C */
	__IO uint32_t PMC_PATCH_GRP1_1;                       /*!<  Register,  Address offset: 0x040 */
	__IO uint32_t PMC_PATCH_GRP2_0;                       /*!<  Register,  Address offset: 0x044 */
	__IO uint32_t PMC_PATCH_GRP2_1;                       /*!<  Register,  Address offset: 0x048 */
	__IO uint32_t PMC_PATCH_GRP3_0;                       /*!<  Register,  Address offset: 0x04C */
	__IO uint32_t PMC_PATCH_GRP3_1;                       /*!<  Register,  Address offset: 0x050 */
	__IO uint32_t PMC_PATCH_GRP4_0;                       /*!<  Register,  Address offset: 0x054 */
	__IO uint32_t PMC_PATCH_GRP4_1;                       /*!<  Register,  Address offset: 0x058 */
	__IO uint32_t PMC_PATCH_GRP5_0;                       /*!<  Register,  Address offset: 0x05C */
	__IO uint32_t PMC_PATCH_GRP5_1;                       /*!<  Register,  Address offset: 0x060 */
} PMC_TypeDef;

#define PMC_BASE ((PMC_TypeDef *) (0x42008300))
