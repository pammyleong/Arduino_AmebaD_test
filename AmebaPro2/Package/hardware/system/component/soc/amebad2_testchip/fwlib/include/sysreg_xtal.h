...
#define XTAL_BIT_POW_XTAL              ((u32)0x00000001 << 1)          /*!<R   0 to 1 Enable xtal */
#define XTAL_BIT_POW_BG                ((u32)0x00000001 << 0)          /*!<R   Enable BG (BG for xtal and AFE) (有option關) */
/** @} */
...
#define XTAL_BIT_EN_XTAL_AAC_GM        ((u32)0x00000001 << 23)          /*!<R/W 0  1: enable xtal aac gm control */
...
#define XTAL_BIT_DRV_RF_LATCH          ((u32)0x00000001 << 6)          /*!<R/W 1  1: latch enable */
 ...
 * @{
 **/
#define XTAL_BIT_EN_XTAL_AAC_TRIG      ((u32)0x00000001 << 29)          /*!<R/W 0  MAC內部訊號 Set by pmc and clr by HW finish calibration */
#define XTAL_BIT_EN_XTAL_AAC           ((u32)0x00000001 << 28)          /*!<R/W 0  MAC內部訊號 0: 不做AAC (default), 1: power on 做AAC */
#define XTAL_BIT_EN_XTAL_AAC_DIGI      ((u32)0x00000001 << 27)          /*!<R/W 0  1:enable aac digital circuit */
#define XTAL_MASK_GM_MANUAL            ((u32)0x0000001F << 22)          /*!<R/W 11111  Gm manual at EN_XTAL_AAC_DIGI=0 */
#define XTAL_GM_MANUAL(x)              ((u32)(((x) & 0x0000001F) << 22))
#define XTAL_GET_GM_MANUAL(x)          ((u32)(((x >> 22) & 0x0000001F)))
...
#define XTAL_MASK_LDO_LPS              ((u32)0x00000007 << 22)          /*!<R/W 100  (起震後, 進入LPS時) 111: 1.1V 110: 1.05V 101:1V 100:0.95V 011: 0.9V 010: 0.85V 001: 0.8V 000: 0.75V */
...
#define XTAL_BIT_POW_XTAL_LPS          ((u32)0x00000001 << 3)          /*!<R/W 0  POW_XTAL_LPS */
#define XTAL_BIT_MODE                  ((u32)0x00000001 << 2)          /*!<R 1  22C xtal mode define: {POW_XTAL, XTAL_MODE, POW_XTAL_LPS} [efuse for power on ] */
/** @} */
...
/**
 * @brief AMEBAD_XTAL Register Declaration
 *****************************************************************************/
typedef struct {
