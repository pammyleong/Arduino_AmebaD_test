 ...
 * @{
 **/
#define COMP_MASK_POWON_CNT              ((u32)0x000000FF << 24)          /*!<R/W 64h  This field defines how long the comparator analog module can work after the comparator is enabled, this is about 40us. */
#define COMP_POWON_CNT(x)                ((u32)(((x) & 0x000000FF) << 24))
#define COMP_GET_POWON_CNT(x)            ((u32)(((x >> 24) & 0x000000FF)))
#define COMP_MASK_DATA_VALID_CNT         ((u32)0x000000FF << 16)          /*!<R/W 6Eh  This field defines how long the comparator analog module data is valid for digital module after analog module works. */
#define COMP_DATA_VALID_CNT(x)           ((u32)(((x) & 0x000000FF) << 16))
#define COMP_GET_DATA_VALID_CNT(x)       ((u32)(((x >> 16) & 0x000000FF)))
#define COMP_MASK_CHSW_CNT               ((u32)0x000000FF << 8)          /*!<R/W 3Ch  This field defines how long the channel switch can jump to next channel at automatic channel switch mode. */
#define COMP_CHSW_CNT(x)                 ((u32)(((x) & 0x000000FF) << 8))
#define COMP_GET_CHSW_CNT(x)             ((u32)(((x >> 8) & 0x000000FF)))
#define COMP_MASK_EXT_WK_SHUT_CNT        ((u32)0x000000FF << 0)          /*!<R/W 96h  This field defines how long to disable comparator analog module when an external trigger event is sent to the comparator. The count must include the comparator response time to get a correct compare result. */
...
/** @defgroup COMP_Channel_List_Shift_Definitions
  * @{
  */
...
/** @defgroup COMP_Channel_Status_Definitions
  * @{
  */
