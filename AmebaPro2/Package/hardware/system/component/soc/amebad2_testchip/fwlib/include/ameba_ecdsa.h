...
/**
 * @brief ECDSA ecp group definition
 */
typedef struct {
...
/** @defgroup ECDSA_CURVE_definitions
  * @{
  */
...
/** @defgroup ECDSA_MODE_definitions
  * @{
  */
...
_LONG_CALL_ int ECDSA_KeyGen(ECDSA_TypeDef *ECDSA, u32 curve_id, u8 *d, u8 *Qx, u8 *Qy);
_LONG_CALL_ int ECDSA_Sign(ECDSA_TypeDef *ECDSA, u32 curve_id, u8 *d, u8 *k, const u8 *hbuf, u32 hlen, u8 *Qx, u8 *Qy, u8 *r, u8 *s);
