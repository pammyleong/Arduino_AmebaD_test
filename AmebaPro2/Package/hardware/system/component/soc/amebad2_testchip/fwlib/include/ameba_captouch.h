 ...
 * @{
 **/
#define CT_MASK_ADC_REG1X_LPAD31_6       ((u32)0x03FFFFFF << 6)          /*!<R/W 0h  [31:8]: Reserved [7:6]: reg_vcmin[1: 0], vcmin voltage set 00: 0.45V 01: 0.44V 10: 0.43V 00: 0.42V */
 ...
 * @{
 **/
#define CT_MASK_ADC_REG0X_LPSD31_14      ((u32)0x0003FFFF << 14)          /*!<R/W 490h  [31:25]: RSVD [24:22]: VR1200_tune<2: 0>, add 40k per step fine tune BG [21:19]: R2_tune<2: 0>, add 20k per step fine tune BG [18:16]: R1_tune<2: 0>, add 200k per step fine tune BG [15]: RSVD [14]: POW_MBIAS, power on mbias */
...
#define CT_MASK_ADC_REG0X_LPSD11_0       ((u32)0x00000FFF << 0)          /*!<R/W 0h  [11:7]: SEL_VREFL, vref low voltage 0000: 25mV, 25mV/step [6:2]: SEL_VREFH, vref high voltage 0000: 25mV, 25mV/step [1]: SD_POSEDGE, 1: vin>vref output high [0]: POW_SD, power on SD */
 ...
 * @{
 **/
#define CT_MASK_ADC_PC_SET               ((u32)0x000000FF << 8)          /*!<R/W 16h  Time between REG0X_LPAD[0] power LDO/mbias/res ladder and REG0X_LPAD[2] pow_ref, unit is 128K clock */
#define CT_ADC_PC_SET(x)                 ((u32)(((x) & 0x000000FF) << 8))
#define CT_GET_ADC_PC_SET(x)             ((u32)(((x >> 8) & 0x000000FF)))
#define CT_MASK_ADC_REF_SET              ((u32)0x000000FF << 0)          /*!<R/W 2h  Time between REG0X_LPAD[2] power_ref and REG0X_LPAD[1] pow, unit is 128K clock */
