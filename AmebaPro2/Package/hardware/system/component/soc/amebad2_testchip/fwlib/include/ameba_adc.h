 ...
 * @{
 **/
#define ADC_MASK_FULL_LVL                   ((u32)0x0000000F << 0)          /*!<R/W 0h  This field defines the FIFO full entry thredshold level and it's used for FIFO full interrupt. It should be set according to ADC FIFO depth. A value of 0 sets the threshold for 1 entry, and a value of 15 sets the threshold for 16 entries. */
#define ADC_FULL_LVL(x)                     ((u32)(((x) & 0x0000000F) << 0))
#define ADC_GET_FULL_LVL(x)                 ((u32)(((x >> 0) & 0x0000000F)))
/** @} */
 ...
 * @{
 **/
#define ADC_BIT_DAT_RDY_CHx                 ((u32)0x00000001 << 17)          /*!<R 0  This bit indicates that a conversion is done. Every time a conversion is done, this bit should be set to 1 and it would be cleared to 0 when a read operation of reg_adc_data_global. */
...
#define ADC_MASK_DATA_CHx                   ((u32)0x0000FFFF << 0)          /*!<R 0  This field contains the newsest conversion data of channel x */
 ...
 * @{
 **/
#define ADC_MASK_CLK_DIV                    ((u32)0x00000007 << 0)          /*!<R/W 0  This field defines clock driver level of ADC module. A value of 0 is for clock divided by 12. A value of 1 is for clock divided by 16. A value of 2 is for clock divided by 32. A value of 3 is for clock divided by 64. */
...
/** @defgroup ADC_Interrupt_Status_Definitions
  * @{
  */
...
/** @defgroup ADC_CHSW_LIST_Definitions
  * @{
  */
...
/** @defgroup ADC_Comparison_Setting_Definitions
  * @{
  */
...
/** @defgroup ADC_Data_Setting_Definitions
  * @{
  */
