 ...
 * @{
 **/
#define RTC_MASK_WUT        ((u32)0x0001FFFF << 0)          /*!<R/W 0  Wakeup auto-reload value bits When the wakeup timer is enabled (WUTE is set to '1'), the WUTF flag is set every (WUT[15:0]+1) cycles. The first assertion of WUTF occurs between WUT and (WUT+1) cycles after WUTE is set. */
...
/** @defgroup RTC_TR_RSVD_MASK_Definition
  * @{
  */
...
/** @defgroup RTC_TIMEOUT_Definitions
  * @{
  */
...
/** @defgroup RTC_SHIFT_Definitions
  * @{
  */
