...
#define WLAFE_BIT_HW_EN_RFAFE_2REGU          ((u32)0x00000001 << 6)          /*!<R/W 1  control 3.3V power reset of wl rfafe, need level shift to 3.3V by regu */
#define WLAFE_BIT_HW_EN_RFAFE                ((u32)0x00000001 << 5)          /*!<R/W 1  core power reset of wl rfafe */
 ...
 * @{
 **/
#define WLAFE_BIT_CK5M_EN                    ((u32)0x00000001 << 31)          /*!<R/W 1  1: Enable 0: Output "1" */
...
#define WLAFE_MASK_DCK_WAVE_OFSN_CR          ((u32)0x000000FF << 17)          /*!<R/W 00000001  id[7:0] or qd[7:0] = wave_mid_val + wave_ofs_val */
...
#define WLAFE_MASK_DCK_WAVE_OFSP_CR          ((u32)0x000000FF << 17)          /*!<R/W 00000000   */
#define WLAFE_DCK_WAVE_OFSP_CR(x)            ((u32)(((x) & 0x000000FF) << 17))
#define WLAFE_GET_DCK_WAVE_OFSP_CR(x)        ((u32)(((x >> 17) & 0x000000FF)))
#define WLAFE_MASK_DCK_RESERVE_CR            ((u32)0x00000FFF << 5)          /*!<R/W 000000000000   */
#define WLAFE_DCK_RESERVE_CR(x)              ((u32)(((x) & 0x00000FFF) << 5))
#define WLAFE_GET_DCK_RESERVE_CR(x)          ((u32)(((x >> 5) & 0x00000FFF)))
...
/**
 * @brief AMEBAD_WLAFE Register Declaration
 *****************************************************************************/
typedef struct {
	...
	__IO uint32_t RSVD0[4];                               /*!<  Reserved,  Address offset:0x10-0x1C */
