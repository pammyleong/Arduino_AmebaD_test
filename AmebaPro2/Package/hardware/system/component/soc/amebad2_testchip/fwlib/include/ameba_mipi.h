...
/**
 * @brief MIPI Register Declaration
 *****************************************************************************/
typedef struct {
...
/* Exported Types --------------------------------------------------------*/
/** @addtogroup MIPI_Exported_Types MIPI Exported Types
  * @{
  */
...
/** @defgroup MIPI_Video_Data_Format
  * @{
  */
...
/** @defgroup MIPI_Video_Mode_Interface
  * @{
  */
...
/** @defgroup MIPI_Command_Mode_DCS_CMD
  * @{
  */
