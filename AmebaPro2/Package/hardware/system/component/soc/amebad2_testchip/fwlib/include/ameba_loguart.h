...
typedef struct {
	...
	__I  uint32_t LOGUART_UART_REG_DBG;                   /*!< UART DEBUG REGISTER,  Address offset: 0x038 */
	__IO uint32_t RSVD0;                                  /*!<  Reserved,  Address offset:0x3C */
...
typedef struct {
	...
	u32	WordLen;		/*!< Specifies the LOGUART word length.
										This parameter can be a value of @ref LOGUART_Word_length_define. */

	u32	StopBit;		/*!< Specifies the LOGUART stop bit number.
										This parameter can be a value of @ref LOGUART_Stop_Bit_define. */

	u32	Parity;			/*!< Specifies the LOGUART parity.
										This parameter can be a value of @ref LOGUART_Parity_Enable_define. */

	u32	ParityType;		/*!< Specifies the LOGUART parity type.
										This parameter can be a value of @ref LOGUART_Parity_Type_define. */

	u32	StickParity;	/*!< Specifies the LOGUART stick parity.
										This parameter can be a value of @ref LOGUART_Stick_Parity_Type_define. */

	u32	FlowControl;	/*!< Specifies the LOGUART auto flow control.
										This parameter can be ENABLE or DISABLE. */

	u32	RxFifoTrigLevel;	/*!< Specifies the LOGUART rx fifo trigger level.
										This parameter can be a value of @ref LOGUART_RX_FIFO_TRIGGER_LEVEL_define. */

	u32	RxErReportCtrl;		/*!< Specifies the LOGUART rx error report control.
										This parameter can be a value of @ref LOGUART_Rx_Err_Report_define. */
...
/**
  * @brief  LOGUART Port structure definition
  */
typedef struct {
	u32 idx;
	u32 not_full;
...
/** @defgroup LOGUART_RX_FIFO_TRIGGER_LEVEL_define
  * @{
  */
...
/** @defgroup LOGUART_AGG_THRESHOLD_LEVEL_define
  * @{
  */
...
/** @defgroup LOGUART_PATH_INDEX_define
  * @{
  */
...
/** @defgroup LOGUART_Word_length_define
  * @{
  */
...
/** @defgroup LOGUART_Stop_Bit_define
  * @{
  */
...
/** @defgroup LOGUART_Parity_Enable_define
  * @{
  */
...
/** @defgroup LOGUART_Parity_Type_define
  * @{
  */
...
/** @defgroup LOGUART_Stick_Parity_Type_define
  * @{
  */
...
/** @defgroup LOGUART_Rx_Err_Report_define
  * @{
  */
...
/** @defgroup LOGUART_Tx_Empty_Intr_Enable_define
  * @{
  */
...
_LONG_CALL_ void LOGUART_AGGCmd(LOGUART_TypeDef *UARTx, u32 NewState);
_LONG_CALL_ void LOGUART_AGGPathCmd(LOGUART_TypeDef *UARTx, u8 PathIndex, u32 NewState);
_LONG_CALL_ void LOGUART_AGGSetTimeOut(LOGUART_TypeDef *UARTx, u32 TimeOut);
_LONG_CALL_ void LOGUART_AGGSetThreshold(LOGUART_TypeDef *UARTx, u32 Threshold);
_LONG_CALL_ void LOGUART_AGGSetSyncPattern(LOGUART_TypeDef *UARTx, u32 SyncPattern);
...
_LONG_CALL_ void LOGUART_INTConfig(LOGUART_TypeDef *UARTx, u32 UART_IT, u32 newState);
_LONG_CALL_ void LOGUART_INTClear(LOGUART_TypeDef *UARTx, u32 UART_IT);
_LONG_CALL_ u32 LOGUART_GetStatus(LOGUART_TypeDef *UARTLOG);
_LONG_CALL_ u32 LOGUART_ClearRxFifo(LOGUART_TypeDef *UARTx);
