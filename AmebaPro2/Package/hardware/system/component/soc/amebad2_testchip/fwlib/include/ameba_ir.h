...
#define IR_MASK_RX_FILTER_STAGETX            ((u32)0x00000007 << 21)          /*!<R/W 0x0  *0x0: Filter <= 20ns glitch *0x1: Filter <= 30ns glitch *0x2: Filter <= 40ns glitch *0x3: Filter <= 50ns glitch бн */
 ...
 *****************************************************************************/
typedef struct {
	__IO uint32_t IR_CLK_DIV;                             /*!<  Register,  Address offset: 0x000 */
	__IO uint32_t IR_TX_CONFIG;                           /*!<  Register,  Address offset: 0x004 */
	__I  uint32_t IR_TX_SR;                               /*!<  Register,  Address offset: 0x008 */
	__IO uint32_t IR_TX_COMPE_DIV;                        /*!<  Register,  Address offset: 0x00C */
	__O  uint32_t IR_TX_INT_CLR;                          /*!<  Register,  Address offset: 0x010 */
	__O  uint32_t IR_TX_FIFO;                             /*!<  Register,  Address offset: 0x014 */
	__IO uint32_t IR_RX_CONFIG;                           /*!<  Register,  Address offset: 0x018 */
	__I  uint32_t IR_RX_SR;                               /*!<  Register,  Address offset: 0x01C */
	__O  uint32_t IR_RX_INT_CLR;                          /*!<  Register,  Address offset: 0x020 */
	__IO uint32_t IR_RX_CNT_INT_SEL;                      /*!<  Register,  Address offset: 0x024 */
	__I  uint32_t IR_RX_FIFO;                             /*!<  Register,  Address offset: 0x028 */
	__I  uint32_t IR_VERSION;                             /*!<  Register,  Address offset: 0x02C */
} IR_TypeDef;
/** @} */
/* AUTO_GEN_END */
