...
#define WAIT_FRAME_TIME			(1660 * 1000) 			/* 1 sec, wait frame timeout */
#define WAIT_CHAR_TIME				(830 * 1000)			/* 0.5 sec, wait char timeout */
#define WAIT_TIME_SERVER			(3320 * 1000)		/* 2 sec, server wait timeout */
#define WAIT_HANDSHAKE_TIME		(1660 * 1000)		/* 1 sec, handshake timeout */
#define WAIT_NAK_PERIOD				(83 * 1000)			/* 50 ms, period of send NAK when handshake */
