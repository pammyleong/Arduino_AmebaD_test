...
#define DDRPHY_MASK_DPI_MCK_CLK_EN             ((u32)0x00001FFF << 0)          /*!<R/W h000  DDR_PHY internal clock ICG enable ck_en[12:0]: clock enable ck_en[0]: mck_ck ck_en[1]: mck_cmd ck_en[2]: mck_dqs_0 ck_en[3]: mck_dqs_1 ck_en[4]: mck_dqs_2 ck_en[5]: mck_dqs_3 ck_en[6]: mck_dq_0 ck_en[7]: mck_dq_1 ck_en[8]: mck_dq_2 ck_en[9]: mck_dq_3 ck_en[10]: mck_cs ck_en[11]: mck_cs_1 ck_en[12]: mck_ck_1 */
 ...
 * @{
 *****************************************************************************/
#define DDRPHY_MASK_DPI_V11_LDO_VSEL           ((u32)0x00000007 << 29)          /*!<R/W h0  Select PLL 1.0V LDO output 000: digital core power 3'b001: 1.0V 3'b010: 1.05V 3'b011: 1.1V 3'b100: 1.15V 3'b101: 1.2V 3'b110: 1.25V 3'b111: 1.3V */
...
#define DDRPHY_MASK_DPI_PLL_LDO_VSEL           ((u32)0x00000007 << 19)          /*!<R/W h5  Select PLL 1.0V LDO output 000: tracking core power 001: 0.8V 010: 0.85V 011: 0.9V 100: 0.95V 101: 1.0V 110: 1.05V 111: 1.1V */
...
#define DDRPHY_MASK_DPI_GRAN_SET               ((u32)0x0007FFFF << 0)          /*!<R/W h021FB  SSC step SSC step=(Fssc-F) / (0.5*Tssc) */
...
#define DDRPHY_BIT_DPI_WD_ENABLE               ((u32)0x00000001 << 0)          /*!<R/W b0  Watchdog function enable 0: disable watchdog function 1: enable watchdog function */
 ...
 * @{
 *****************************************************************************/
#define DDRPHY_BIT_DPI_DCC_CS_x_DSP_DBG_SEL    ((u32)0x00000001 << 31)          /*!<R/W b0  mck_cs_x duty control debug output enable */
#define DDRPHY_DPI_DCC_CS_x_DSP_DBG_SEL(x)     ((u32)(((x) & 0x00000001) << 31))
#define DDRPHY_BIT_DPI_DCC_CS_x_DUTY_SEL       ((u32)0x00000001 << 29)          /*!<R/W b0  mck_cs_x duty control reg_dpi_dcc_cs_duty_sel=0: output from close loop reg_dpi_dcc_cs_duty_sel=1: output from reg_dpi_dcc_cs_duty[6:0] */
#define DDRPHY_DPI_DCC_CS_x_DUTY_SEL(x)        ((u32)(((x) & 0x00000001) << 29))
#define DDRPHY_BIT_DPI_DCC_CS_x_DSP_STOP       ((u32)0x00000001 << 28)          /*!<R/W b1  mck_cs_x duty control dsp function enable */
#define DDRPHY_DPI_DCC_CS_x_DSP_STOP(x)        ((u32)(((x) & 0x00000001) << 28))
#define DDRPHY_MASK_DPI_DCC_CS_x_DIV           ((u32)0x00000007 << 24)          /*!<R/W h5  mck_cs_x duty control dsp clock frequency setting: 000: 2^4 001: 2^5 010: 2^6 011:2^7 100: 2^8 101: 2^9 110: 2^10 111: 2^11 */
#define DDRPHY_DPI_DCC_CS_x_DIV(x)             ((u32)(((x) & 0x00000007) << 24))
#define DDRPHY_GET_DPI_DCC_CS_x_DIV(x)         ((u32)(((x >> 24) & 0x00000007)))
#define DDRPHY_MASK_DPI_DCC_CS_x_INT_GAIN      ((u32)0x0000001F << 16)          /*!<R/W h05  mck_cs_x duty control close loop gain setting: 00000~11111: 2^6 ~ 2^ */
#define DDRPHY_DPI_DCC_CS_x_INT_GAIN(x)        ((u32)(((x) & 0x0000001F) << 16))
#define DDRPHY_GET_DPI_DCC_CS_x_INT_GAIN(x)    ((u32)(((x >> 16) & 0x0000001F)))
#define DDRPHY_MASK_DPI_DCC_CS_x_DUTY          ((u32)0x0000007F << 8)          /*!<R/W h38  mck_cs_x duty control when reg_dpi_dcc_cs_duty_sel=1'b0,output value from this register */
#define DDRPHY_DPI_DCC_CS_x_DUTY(x)            ((u32)(((x) & 0x0000007F) << 8))
#define DDRPHY_GET_DPI_DCC_CS_x_DUTY(x)        ((u32)(((x >> 8) & 0x0000007F)))
#define DDRPHY_MASK_DPI_DCC_CS_x_DUTY_PRESETB  ((u32)0x00000007 << 4)          /*!<R/W h3  mck_cs_x duty control DCD negitive duty preset setting */
...
#define DDRPHY_MASK_DPI_DCC_CS_x_DUTY_PRESETA  ((u32)0x00000007 << 0)          /*!<R/W h3  mck_cs_x duty control DCD positive duty preset setting */
...
#define DDRPHY_MASK_ZCTRL_CLK_SEL              ((u32)0x00000003 << 25)          /*!<R/W h2  Zctrl clock select 00: zclk/8 01: zclk/16 10: zclk/32 11: zclk/64 */
...
#define DDRPHY_BIT_CKE_1_GEARDOWN              ((u32)0x00000001 << 24)          /*!<R/W ‘h0  0: normal 1: gear down */
#define DDRPHY_CKE_1_GEARDOWN(x)               ((u32)(((x) & 0x00000001) << 24))
#define DDRPHY_BIT_CKE_GEARDOWN                ((u32)0x00000001 << 23)          /*!<R/W ‘h0  0: normal 1: gear down */
#define DDRPHY_CKE_GEARDOWN(x)                 ((u32)(((x) & 0x00000001) << 23))
#define DDRPHY_BIT_CS_1_GEARDOWN               ((u32)0x00000001 << 22)          /*!<R/W ‘h0  0: normal 1: gear down */
#define DDRPHY_CS_1_GEARDOWN(x)                ((u32)(((x) & 0x00000001) << 22))
#define DDRPHY_BIT_CS_GEARDOWN                 ((u32)0x00000001 << 21)          /*!<R/W ‘h0  0: normal 1: gear down */
#define DDRPHY_CS_GEARDOWN(x)                  ((u32)(((x) & 0x00000001) << 21))
#define DDRPHY_BIT_CMD_GEARDOWN                ((u32)0x00000001 << 20)          /*!<R/W ‘h0  0: normal 1: gear down */
 ...
 * @{
 *****************************************************************************/
#define DDRPHY_MASK_DQ_PAT_IN0                 ((u32)0xFFFFFFFF << 0)          /*!<R h0  Read data from DDR when dq_latch_en is high (dq_pat_in = 0 when dq_latch_en is low) [31] dq31 ... [1] dq01 [0] dq00 */
 ...
 * @{
 *****************************************************************************/
#define DDRPHY_MASK_DQ_PAT_IN1                 ((u32)0x0000000F << 0)          /*!<R h0  Read data from DDR when dq_latch_en is high (dq_pat_in = 0 when dq_latch_en is low) [3] dbi3 [2] dbi2 [1] dbi1 [0] dbi0 */
...
#define DDRPHY_MASK_DTP_DQ                     ((u32)0x0000000F << 0)          /*!<R/W ‘h0  0: DTP of DQ[7:0], 1: DTP of DQ[15:8], 2: DTP of DQ[23:16], 3: DTP of DQ[31:24] Note1: DTP means high-period input duty trimming Note2: DTN meams low-period input duty trimming */
...
#define DDRPHY_BIT_VREF_SEL                    ((u32)0x00000001 << 28)          /*!<R/W ‘h0  VREF SEL for VREFZQ pad When REFZQ.VREF_SEL = 1'b1,use resistor voltage divider to calibrate R480Ohm, when vref_sel = 1'b0, use bandgap voltage divider to calibrate R480 */
#define DDRPHY_VREF_SEL(x)                     ((u32)(((x) & 0x00000001) << 28))
#define DDRPHY_BIT_VREF_RANGE                  ((u32)0x00000001 << 27)          /*!<R/W ‘h1  VREF VREF_RANGE for VREFZQ pad 1'b1: 0.5% ~ 64.5% 1'b0: 28% ~ 92% */
#define DDRPHY_VREF_RANGE(x)                   ((u32)(((x) & 0x00000001) << 27))
#define DDRPHY_MASK_VREF_S                     ((u32)0x0000003F << 21)          /*!<R/W ‘hA  VREF S for VREFZQ pad Control Vref voltage with vref_range, and add 1% voltage when add 1 level */
...
#define DDRPHY_BIT_VREF_PD                     ((u32)0x00000001 << 18)          /*!<R/W ‘h0  VREF pd for VREFZQ pad Power down Vref. zq_pd = 1 when use external Vref, zq_pad = 0 when use internal Vref */
...
#define DDRPHY_BIT_VREF_RANGE_4                ((u32)0x00000001 << 15)          /*!<R/W ‘h1  VREF VREF_RANGE for normal Command/Address(CA) VREF pad 1'b1: 0.5% ~ 64.5% 1'b0: 28% ~ 92% */
#define DDRPHY_VREF_RANGE_4(x)                 ((u32)(((x) & 0x00000001) << 15))
#define DDRPHY_MASK_VREF_S_4                   ((u32)0x0000003F << 9)          /*!<R/W ‘hA  VREF S for normal CA VREF pad Control Vref voltage with vref_range, and add 1% voltage when add 1 level */
#define DDRPHY_VREF_S_4(x)                     ((u32)(((x) & 0x0000003F) << 9))
#define DDRPHY_GET_VREF_S_4(x)                 ((u32)(((x >> 9) & 0x0000003F)))
#define DDRPHY_BIT_VREF_PD_4                   ((u32)0x00000001 << 8)          /*!<R/W ‘h0  VREF pd for normal CA VREF pad */
 ...
 * @{
 *****************************************************************************/
#define DDRPHY_BIT_VREF_RANGE_3                ((u32)0x00000001 << 31)          /*!<R/W ‘h1  VREF VREF_RANGE for normal byte-3 VREF pad 1'b1: 0.5% ~ 64.5% 1'b0: 28% ~ 92% */
#define DDRPHY_VREF_RANGE_3(x)                 ((u32)(((x) & 0x00000001) << 31))
#define DDRPHY_MASK_VREF_S_3                   ((u32)0x0000003F << 25)          /*!<R/W ‘hA  VREF S for normal byte-3 VREF pad Control Vref voltage with vref_range, and add 1% voltage when add 1 level */
...
#define DDRPHY_BIT_VREF_RANGE_2                ((u32)0x00000001 << 23)          /*!<R/W ‘h1  VREF VREF_RANGE for normal byte-2 VREF pad 1'b1: 0.5% ~ 64.5% 1'b0: 28% ~ 92% */
#define DDRPHY_VREF_RANGE_2(x)                 ((u32)(((x) & 0x00000001) << 23))
#define DDRPHY_MASK_VREF_S_2                   ((u32)0x0000003F << 17)          /*!<R/W ‘hA  VREF S for normal byte-2 VREF pad Control Vref voltage with vref_range, and add 1% voltage when add 1 level */
...
#define DDRPHY_BIT_VREF_RANGE_1                ((u32)0x00000001 << 15)          /*!<R/W ‘h1  VREF VREF_RANGE for normal byte-1 VREF pad 1'b1: 0.5% ~ 64.5% 1'b0: 28% ~ 92% */
#define DDRPHY_VREF_RANGE_1(x)                 ((u32)(((x) & 0x00000001) << 15))
#define DDRPHY_MASK_VREF_S_1                   ((u32)0x0000003F << 9)          /*!<R/W ‘hA  VREF S for normal byte-1 VREF pad Control Vref voltage with vref_range, and add 1% voltage when add 1 level */
...
#define DDRPHY_BIT_VREF_RANGE_0                ((u32)0x00000001 << 7)          /*!<R/W ‘h1  VREF VREF_RANGE for normal byte-0 VREF pad 1'b1: 0.5% ~ 64.5% 1'b0: 28% ~ 92% */
 ...
 * @{
 *****************************************************************************/
#define DDRPHY_MASK_CA_TTCN_SEL                ((u32)0x00000007 << 4)          /*!<R/W h1  N-OCD selection for all address/command pad, except CKE and CSN 000: ocdn_set_0 ... 111: ocdn_set_7 */
#define DDRPHY_CA_TTCN_SEL(x)                  ((u32)(((x) & 0x00000007) << 4))
#define DDRPHY_GET_CA_TTCN_SEL(x)              ((u32)(((x >> 4) & 0x00000007)))
#define DDRPHY_MASK_CA_TTCP_SEL                ((u32)0x00000007 << 0)          /*!<R/W h1  P-OCD selection for all address/command pad, except CKE and CSN 000: ocdp_set_0 ... 111: ocdp_set_7 */
 ...
 * @{
 *****************************************************************************/
#define DDRPHY_MASK_CKE_1_TTCN_SEL             ((u32)0x00000007 << 12)          /*!<R/W h1  TTCN selection for CKE_1 (no use) 000: ocdn_set_0 ... 111: ocdn_set_7 */
#define DDRPHY_CKE_1_TTCN_SEL(x)               ((u32)(((x) & 0x00000007) << 12))
#define DDRPHY_GET_CKE_1_TTCN_SEL(x)           ((u32)(((x >> 12) & 0x00000007)))
#define DDRPHY_MASK_CKE_1_TTCP_SEL             ((u32)0x00000007 << 8)          /*!<R/W h1  TTCP selection for CKE_1 (no use) 000: ocdp_set_0 ... 111: ocdp_set_7 */
#define DDRPHY_CKE_1_TTCP_SEL(x)               ((u32)(((x) & 0x00000007) << 8))
#define DDRPHY_GET_CKE_1_TTCP_SEL(x)           ((u32)(((x >> 8) & 0x00000007)))
#define DDRPHY_MASK_CKE_TTCN_SEL               ((u32)0x00000007 << 4)          /*!<R/W h1  TTCN selection for CKE 000: ocdn_set_0 ... 111: ocdn_set_7 */
#define DDRPHY_CKE_TTCN_SEL(x)                 ((u32)(((x) & 0x00000007) << 4))
#define DDRPHY_GET_CKE_TTCN_SEL(x)             ((u32)(((x >> 4) & 0x00000007)))
#define DDRPHY_MASK_CKE_TTCP_SEL               ((u32)0x00000007 << 0)          /*!<R/W h1  TTCP selection for CKE 000: ocdp_set_0 ... 111: ocdp_set_7 */
 ...
 * @{
 *****************************************************************************/
#define DDRPHY_MASK_CS_1_TTCN_SEL              ((u32)0x00000007 << 28)          /*!<R/W h1  TTCN selection for CS_1 000: ocdn_set_0 ... 111: ocdn_set_7 */
#define DDRPHY_CS_1_TTCN_SEL(x)                ((u32)(((x) & 0x00000007) << 28))
#define DDRPHY_GET_CS_1_TTCN_SEL(x)            ((u32)(((x >> 28) & 0x00000007)))
#define DDRPHY_MASK_CS_1_TTCP_SEL              ((u32)0x00000007 << 24)          /*!<R/W h1  TTCP selection for CS_1 000: ocdp_set_0 ... 111: ocdp_set_7 */
#define DDRPHY_CS_1_TTCP_SEL(x)                ((u32)(((x) & 0x00000007) << 24))
#define DDRPHY_GET_CS_1_TTCP_SEL(x)            ((u32)(((x >> 24) & 0x00000007)))
#define DDRPHY_MASK_CS_TTCN_SEL                ((u32)0x00000007 << 12)          /*!<R/W h1  TTCN selection for CS 000: ocdn_set_0 ... 111: ocdn_set_7 */
#define DDRPHY_CS_TTCN_SEL(x)                  ((u32)(((x) & 0x00000007) << 12))
#define DDRPHY_GET_CS_TTCN_SEL(x)              ((u32)(((x >> 12) & 0x00000007)))
#define DDRPHY_MASK_CS_TTCP_SEL                ((u32)0x00000007 << 8)          /*!<R/W h1  TTCP selection for CS 000: ocdp_set_0 ... 111: ocdp_set_7 */
#define DDRPHY_CS_TTCP_SEL(x)                  ((u32)(((x) & 0x00000007) << 8))
#define DDRPHY_GET_CS_TTCP_SEL(x)              ((u32)(((x >> 8) & 0x00000007)))
#define DDRPHY_MASK_RST_TTCN_SEL               ((u32)0x00000007 << 4)          /*!<R/W h1  TTCN selection for RSTN 000: ocdn_set_0 ... 111: ocdn_set_7 */
#define DDRPHY_RST_TTCN_SEL(x)                 ((u32)(((x) & 0x00000007) << 4))
#define DDRPHY_GET_RST_TTCN_SEL(x)             ((u32)(((x >> 4) & 0x00000007)))
#define DDRPHY_MASK_RST_TTCP_SEL               ((u32)0x00000007 << 0)          /*!<R/W h1  TTCP selection for RSTN 000: ocdp_set_0 ... 111: ocdp_set_7 */
 ...
 * @{
 *****************************************************************************/
#define DDRPHY_MASK_CK_1_TTCN_SEL              ((u32)0x00000007 << 12)          /*!<R/W h0  TTCN selection for CLK_1 000: ocdn_set_0 ... 111: ocdn_set_7 */
#define DDRPHY_CK_1_TTCN_SEL(x)                ((u32)(((x) & 0x00000007) << 12))
#define DDRPHY_GET_CK_1_TTCN_SEL(x)            ((u32)(((x >> 12) & 0x00000007)))
#define DDRPHY_MASK_CK_1_TTCP_SEL              ((u32)0x00000007 << 8)          /*!<R/W h0  TTCP selection for CLK_1 000: ocdp_set_0 ... 111: ocdp_set_7 */
#define DDRPHY_CK_1_TTCP_SEL(x)                ((u32)(((x) & 0x00000007) << 8))
#define DDRPHY_GET_CK_1_TTCP_SEL(x)            ((u32)(((x >> 8) & 0x00000007)))
#define DDRPHY_MASK_CK_TTCN_SEL                ((u32)0x00000007 << 4)          /*!<R/W h0  TTCN selection for CLK 000: ocdn_set_0 ... 111: ocdn_set_7 */
#define DDRPHY_CK_TTCN_SEL(x)                  ((u32)(((x) & 0x00000007) << 4))
#define DDRPHY_GET_CK_TTCN_SEL(x)              ((u32)(((x >> 4) & 0x00000007)))
#define DDRPHY_MASK_CK_TTCP_SEL                ((u32)0x00000007 << 0)          /*!<R/W h0  TTCP selection for CLK 000: ocdp_set_0 ... 111: ocdp_set_7 */
...
#define DDRPHY_BIT_BIST_EN                     ((u32)0x00000001 << 23)          /*!<R/W ‘h0  1: Enable bist circuit in PHY 0: Disable bist circuit & reset all flag of bist */
 ...
 * @{
 *****************************************************************************/
#define DDRPHY_BIT_ALERT_TIE_HI                ((u32)0x00000001 << 13)          /*!<R/W ‘h0  1'b1: alert pad was tied to high */
#define DDRPHY_ALERT_TIE_HI(x)                 ((u32)(((x) & 0x00000001) << 13))
#define DDRPHY_BIT_ALERT_OUT_1                 ((u32)0x00000001 << 12)          /*!<R/W ‘h0  1'b1: alert_out_1 goes low */
#define DDRPHY_ALERT_OUT_1(x)                  ((u32)(((x) & 0x00000001) << 12))
#define DDRPHY_BIT_ALERT_OUT                   ((u32)0x00000001 << 11)          /*!<R/W ‘h0  1'b1: alert_out_0 goes low */
 ...
 * @{
 *****************************************************************************/
#define DDRPHY_MASK_TEST4_PATTERN              ((u32)0xFFFFFFFF << 0)          /*!<R/W ‘h0  32-bit test pattern for prbs11 or ten: [31:8]: reserved [7]: DDR4_CS_n [6]: ACT_n [5]: DDR4_CKE [4]: DDR4_BG0 [3]: PARITY_in [2]: PARITY_in_1 [1]: ALERT_in [0]: ALERT_in_1 */
...
#define DDRPHY_BIT_DM_OE_FRC_EN                ((u32)0x00000001 << 2)          /*!<R/W h0  FW can set 1 to control OE of DM pad bit0: DM of slice */
 ...
 *****************************************************************************/
typedef struct {
	__IO uint32_t DDRPHY_CRT_CTL;                         /*!<  Register,  Address offset: 0x00 */
	__IO uint32_t DDRPHY_PLL_CTL0;                        /*!<  Register,  Address offset: 0x04 */
	__IO uint32_t DDRPHY_PLL_CTL1;                        /*!<  Register,  Address offset: 0x08 */
	__IO uint32_t DDRPHY_PLL_CTL2;                        /*!<  Register,  Address offset: 0x0C */
	__IO uint32_t DDRPHY_PLL_PI0;                         /*!<  Register,  Address offset: 0x10 */
	__IO uint32_t DDRPHY_PLL_PI1;                         /*!<  Register,  Address offset: 0x14 */
	__IO uint32_t DDRPHY_PLL_CTL3;                        /*!<  Register,  Address offset: 0x18 */
	__IO uint32_t DDRPHY_SSC0;                            /*!<  Register,  Address offset: 0x1C */
	__IO uint32_t DDRPHY_SSC1;                            /*!<  Register,  Address offset: 0x20 */
	__IO uint32_t DDRPHY_SSC2;                            /*!<  Register,  Address offset: 0x24 */
	__IO uint32_t DDRPHY_SSC3;                            /*!<  Register,  Address offset: 0x28 */
	__IO uint32_t DDRPHY_WDOG;                            /*!<  Register,  Address offset: 0x2C */
	__IO uint32_t DDRPHY_DCC_CMD;                         /*!<  Register,  Address offset: 0x30 */
	__IO uint32_t DDRPHY_DCC_DQS_SETx[4];                 /*!<  Register,  Address offset: 0x34-0x40 */
	__IO uint32_t DDRPHY_DCC_DQ_SETx[4];                  /*!<  Register,  Address offset: 0x44-0x50 */
	__IO uint32_t DDRPHY_DCC_CK_SETx[2];                  /*!<  Register,  Address offset: 0x54-0x58 */
	__IO uint32_t RSVD0;                                  /*!<  Reserved,  Address offset:0x5C */
	__IO uint32_t DDRPHY_CRT_CTL_2;                       /*!<  Register,  Address offset: 0x60 */
	__IO uint32_t RSVD1[7];                               /*!<  Reserved,  Address offset:0x64-0x7C */
	__IO uint32_t DDRPHY_AFIFO_STR_0;                     /*!<  Register,  Address offset: 0x80 */
	__IO uint32_t DDRPHY_AFIFO_STR_1;                     /*!<  Register,  Address offset: 0x84 */
	__IO uint32_t DDRPHY_AFIFO_STR_2;                     /*!<  Register,  Address offset: 0x88 */
	__IO uint32_t DDRPHY_CRT_RST_CTL;                     /*!<  Register,  Address offset: 0x8C */
	__IO uint32_t RSVD2;                                  /*!<  Reserved,  Address offset:0x90 */
	__IO uint32_t DDRPHY_AFIFO_STR_SEL;                   /*!<  Register,  Address offset: 0x94 */
	__IO uint32_t DDRPHY_PLL_PI2;                         /*!<  Register,  Address offset: 0x98 */
	__IO uint32_t DDRPHY_PLL_CTL4;                        /*!<  Register,  Address offset: 0x9C */
	__IO uint32_t DDRPHY_PLL_PI3;                         /*!<  Register,  Address offset: 0xA0 */
	__IO uint32_t DDRPHY_DCC_CSx[2];                      /*!<  Register,  Address offset: 0xA4-0xA8 */
	__IO uint32_t DDRPHY_PLL_CTL5;                        /*!<  Register,  Address offset: 0xAC */
	...
	__IO uint32_t RSVD5[3];                               /*!<  Reserved,  Address offset:0x288-0x290 */
	...
	__IO uint32_t DDRPHY_ADR_EMPH_SEL_0[2];               /*!<  Register,  Address offset: 0x2BC-0x2C0 */
