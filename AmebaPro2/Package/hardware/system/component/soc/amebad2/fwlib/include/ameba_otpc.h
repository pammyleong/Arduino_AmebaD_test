 ...
 * @{
 *****************************************************************************/
#define OTPC_BIT_PCR_PROT_K3    ((u32)0x00000001 << 3)
#define OTPC_BIT_PCR_PROT_K2    ((u32)0x00000001 << 2)
#define OTPC_BIT_PCR_PROT_K1    ((u32)0x00000001 << 1)
#define OTPC_BIT_PCR_PROT_K0    ((u32)0x00000001 << 0)
/** @} */

/**************************************************************************//**
 * @defgroup AMEBAD2_OTPC
 * @{
 * @brief AMEBAD2_OTPC Register Declaration
 *****************************************************************************/
typedef struct {
