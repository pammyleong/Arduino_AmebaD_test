...
typedef struct {
	...
	I2S_InitTypeDef I2S0_Init;

	I2S_InitTypeDef I2S1_Init;

	u32 CODEC_SelDACI2S;				/*!< Specifies the AUDIO CODEC DAC path I2S sel
										This parameter can be a value of @ref CODEC_I2S_Channel */

	u32 CODEC_SelDACLIn;				/*!< Specifies the AUDIO CODEC Channle L DAC path input sel
										This parameter can be a value of @ref DA_SRC_SEL */

	u32 CODEC_SelDACRIn;				/*!< Specifies the AUDIO CODEC Channle R DAC path input sel
										This parameter can be a value of @ref DA_SRC_SEL */

	u32 CODEC_SelADCI2S;				/*!< Specifies the AUDIO CODEC ADC path I2S sel
										This parameter can be a value of @ref CODEC_I2S_Channel */
...
_LONG_CALL_ void AUDIO_CODEC_SetADCASRC(u32 i2s_sel, u32 NewState, u32 tdmmode, u32 sr);
...
_LONG_CALL_ void AUDIO_CODEC_SetHPODiff(void);
...
_LONG_CALL_ void AUDIO_CODEC_MuteDAC(u32 NewState, u32 dac_sel);
