...
struct rxi316_dram_mode_reg_info rxi316_ddr3_mode_reg_1066mhz = {
	...
	0,   // dram_add_lat
	0,   // parity_lat
	2,   // tphy_wd=(DFI_RATIO == 2)? ((wl+1-AC_SHARE) / DFI_RATIO) : (wl  / DFI_RATIO)
	2,  // tphy_rd=(DFI_RATIO == 2)? ((rl+1-AC_SHARE) / DFI_RATIO) : (rl  / DFI_RATIO)
	0,   // mode reg 0 or value
	0,   // mode reg 1 or value
	0,   // mode reg 2 or value
	0,   // mode reg 3 or value
...
//              BUS_ADDR_REMAP
//****************************************************
struct bus_addr_remap_info ddr3_dq16_bus_addr_remap_info = {
	UNREAMP,         // bus_addr[0]
	UNREAMP,         // bus_addr[1]
	UNREAMP,         // bus_addr[2]
...
struct bus_addr_remap_info ddr3_dq32_bus_addr_remap_info = {
	UNREAMP,         // bus_addr[0]
	UNREAMP,         // bus_addr[1]
	UNREAMP,         // bus_addr[2]
	UNREAMP,         // bus_addr[3]
	COLU2_REMAP,     // bus_addr[4]
	COLU3_REMAP,     // bus_addr[5]
	COLU4_REMAP,     // bus_addr[6]
	COLU5_REMAP,     // bus_addr[7]
	COLU6_REMAP,     // bus_addr[8]
	COLU7_REMAP,     // bus_addr[9]
	COLU8_REMAP,     // bus_addr[10]
	COLU9_REMAP,     // bus_addr[11]
	//COLU10_REMAP,    // bus_addr[12]
	//COLU11_REMAP,    // bus_addr[13]
	BANK0_REMAP,     // bus_addr[12]
	BANK1_REMAP,     // bus_addr[13]
	BANK2_REMAP,     // bus_addr[14]
	//BG0_REMAP,       // bus_addr[14]
	//BG1_REMAP,       // bus_addr[15]
	//RANK0_REMAP,     // bus_addr[15]
	ROW0_REMAP,      // bus_addr[15]
	ROW1_REMAP,      // bus_addr[16]
	ROW2_REMAP,      // bus_addr[17]
	ROW3_REMAP,      // bus_addr[18]
	ROW4_REMAP,      // bus_addr[19]
	ROW5_REMAP,      // bus_addr[20]
	ROW6_REMAP,      // bus_addr[21]
	ROW7_REMAP,      // bus_addr[22]
	ROW8_REMAP,      // bus_addr[23]
	ROW9_REMAP,      // bus_addr[24]
	ROW10_REMAP,     // bus_addr[25]
	ROW11_REMAP,     // bus_addr[26]
	ROW12_REMAP,     // bus_addr[27]
	ROW13_REMAP,     // bus_addr[28]
	ROW14_REMAP,     // bus_addr[29]
	ROW15_REMAP,     // bus_addr[30]
	ROW16_REMAP      // bus_addr[31]
	//CH_REMAP        // bus_addr[7]
...
struct slot_starve_reg_info slot_starve_info = {
	...
	// cr_cbctl0
	24,        //cr_lpr_freeslot_num= (((`RCMD_BUF_DEPTH)/4)*3)
	...
	// cr_cbstarve0
	0x400,     //cr_lpr_max_starve=32'h400
	// cr_cbstarve1
	0x400,     //cr_hpr_max_starve=32'h400
	// cr_cbstarve2
	0x400,     //cr_lpw_max_starve=32'h400
	// cr_cbstarve3
	0x400,     //cr_lpr_rmw_max_starve=32'h400
	// cr_cbstarve4
	0x400,     //cr_lpw_rmw_max_starve=32'h400
	// cr_bank_sch_ctrl
	0         //cr_ba_sel_times
};
...
#if    defined DDR2_DRAM
	&rxi316_ddr2_dev,
#elif  defined DDR3_DRAM
	&rxi316_ddr3_dev,
#elif  defined LPDDR1_DRAM
	&rxi316_lpddr1_dev,
#else
	&rxi316_ddr2_dev, // default
#endif
...
#else
	&rxi316_ddr2_mode_reg_1066mhz,     // default, DDR2-1066
#endif // DDR2_DRAM
...
#else
	&rxi316_ddr2_timing_1066mhz,       // default, DDR2-1066
#endif // DDR2_DRAM

	//=== DRAMC Info ===//
	//default bus_addr_remap_info is DQ16, changed to DQ32 if needed
	&rxi316_ddr2_dramc_info,    // default

	//=== DRAM Clock Period(ps) ===//
#if    defined DDR_400
	1000000 / 200,              // DDR-400:  5000ps
#elif  defined DDR_800
	1000000 / 400,              // DDR-800:  2500ps
#elif  defined DDR_1066
	1000000 / 533,              // DDR-1066: 1876ps
#else
	1000000 / 533,              // default, DDR-1066: 1876ps
#endif
