...
/* target address & format address test only support I2C_ADDR_7BIT */
//#define DYNAMIC_TARGET_ADDRESS_TEST
//#define DYNAMIC_FORMAT_ADDRESS_TEST

#define WriteThenRead 1
#define ReadThenWrite 0
