...
/**
  \brief  To cover a special version of bootloader which has hdr_total_size in this structure.
*/
typedef struct hal_xip_page_cfg_s_ext {
    uint8_t is_used;
    uint8_t is_remap;
    uint8_t is_encrypted;
    uint8_t key_id;
...
} hal_xip_page_cfg_ext_t, *phal_xip_page_cfg_ext_t;

#define MAX_PENDING_XIP_PAGE_CFG        6
/**
