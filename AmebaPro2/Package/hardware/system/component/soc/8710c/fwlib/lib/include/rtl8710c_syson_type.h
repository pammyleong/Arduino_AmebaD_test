/**************************************************************************//**
 * @file      rtl8710c_syson_type.h
 * @brief
 * @version   V1.00
 * @date      2019-4-26 20:0:29
 *
 * @note
 *
 ******************************************************************************
...
#ifndef _RTL8710C_SYSON_SYSON_TYPE_H_
#define _RTL8710C_SYSON_SYSON_TYPE_H_
...
/**
 * @addtogroup hs_hal_syson_reg SYSON Register Type.
 * @ingroup hs_hal_syson
 * @{
 */

/**
  \brief Union type to access syson_sys_pwr_iso_ctrl (@ 0x00000000).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x00000000) System Power and Isolation Control Register                */
  ...
  } b;                                        /*!< bit fields for syson_sys_pwr_iso_ctrl */
} syson_sys_pwr_iso_ctrl_t, *psyson_sys_pwr_iso_ctrl_t;

/**
  \brief Union type to access syson_sys_func_en (@ 0x00000008).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x00000008) System Function Control Register                           */
...
/**
  \brief Union type to access syson_sys_clk_ctrl0 (@ 0x00000010).
*/
typedef union {
  ...
  } b;                                        /*!< bit fields for syson_sys_clk_ctrl0 */
} syson_sys_clk_ctrl0_t, *psyson_sys_clk_ctrl0_t;
...
/**
  \brief Union type to access syson_sys_efuse_syscfg0 (@ 0x00000020).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x00000020) System Configuration eFuse Load Register0                  */
  ...
  } b;                                        /*!< bit fields for syson_sys_efuse_syscfg0 */
} syson_sys_efuse_syscfg0_t, *psyson_sys_efuse_syscfg0_t;

/**
  \brief Union type to access syson_sys_efuse_syscfg1 (@ 0x00000024).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x00000024) System Configuration eFuse Load Register1                  */
  ...
  } b;                                        /*!< bit fields for syson_sys_efuse_syscfg1 */
} syson_sys_efuse_syscfg1_t, *psyson_sys_efuse_syscfg1_t;

/**
  \brief Union type to access syson_sys_efuse_syscfg2 (@ 0x00000028).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x00000028) System Configuration eFuse Load Register2                  */
  ...
  } b;                                        /*!< bit fields for syson_sys_efuse_syscfg2 */
} syson_sys_efuse_syscfg2_t, *psyson_sys_efuse_syscfg2_t;

/**
  \brief Union type to access syson_sys_efuse_syscfg3 (@ 0x0000002C).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x0000002C) System Configuration eFuse Load Register3                  */
  ...
  } b;                                        /*!< bit fields for syson_sys_efuse_syscfg3 */
} syson_sys_efuse_syscfg3_t, *psyson_sys_efuse_syscfg3_t;

/**
  \brief Union type to access syson_sys_efuse_syscfg4 (@ 0x00000030).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x00000030) System Configuration eFuse Load Register4                  */
  ...
  struct {
    ...
    __IOM uint32_t dbgio_d_signal_sel : 4;    /*!< [31..28] 0000: DBG[3:0] 0001: DBG[7:4] 0010: DBG[11:8] 0011:
                                                   DBG[15:12] 0100: DBG[19:16] 0101: DBG[23:20] 0110: DBG[27:24]
                                                   0111: DBG[31:28]                                                          */
  } b;                                        /*!< bit fields for syson_sys_efuse_syscfg4 */
} syson_sys_efuse_syscfg4_t, *psyson_sys_efuse_syscfg4_t;

/**
  \brief Union type to access syson_sys_regu_ctrl0 (@ 0x00000040).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x00000040) System Regulator Control Register0                         */
  ...
  } b;                                        /*!< bit fields for syson_sys_regu_ctrl0 */
} syson_sys_regu_ctrl0_t, *psyson_sys_regu_ctrl0_t;

/**
  \brief Union type to access syson_sys_regu_ctrl1 (@ 0x00000044).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x00000044) System Regulator Control Register1                         */
  ...
  } b;                                        /*!< bit fields for syson_sys_regu_ctrl1 */
} syson_sys_regu_ctrl1_t, *psyson_sys_regu_ctrl1_t;

/**
  \brief Union type to access syson_sys_swr_ctrl0 (@ 0x00000048).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x00000048) System Switching Regulator Control Register0               */
  ...
  } b;                                        /*!< bit fields for syson_sys_swr_ctrl0 */
} syson_sys_swr_ctrl0_t, *psyson_sys_swr_ctrl0_t;

/**
  \brief Union type to access syson_sys_swr_ctrl1 (@ 0x0000004C).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x0000004C) System Switching Regulator Control Register1               */
  ...
  } b;                                        /*!< bit fields for syson_sys_swr_ctrl1 */
} syson_sys_swr_ctrl1_t, *psyson_sys_swr_ctrl1_t;

/**
  \brief Union type to access syson_sys_swr_ocp (@ 0x00000058).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x00000058) System Switching Regulator Over Current Protection
                                                                  Control Register                                           */
  ...
  } b;                                        /*!< bit fields for syson_sys_swr_ocp */
} syson_sys_swr_ocp_t, *psyson_sys_swr_ocp_t;

/**
  \brief Union type to access syson_sys_swr_zcd (@ 0x0000005C).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x0000005C) System Switching Regulator Zero Current Detection
                                                                  Control Register                                           */
  ...
  } b;                                        /*!< bit fields for syson_sys_swr_zcd */
} syson_sys_swr_zcd_t, *psyson_sys_swr_zcd_t;

/**
  \brief Union type to access syson_sys_xtal_ctrl0 (@ 0x00000060).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x00000060) System XTAL Control Register0                              */
  ...
  } b;                                        /*!< bit fields for syson_sys_xtal_ctrl0 */
} syson_sys_xtal_ctrl0_t, *psyson_sys_xtal_ctrl0_t;

/**
  \brief Union type to access syson_sys_xtal_ctrl1 (@ 0x00000064).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x00000064) System XTAL Control Register1                              */
  ...
  } b;                                        /*!< bit fields for syson_sys_xtal_ctrl1 */
} syson_sys_xtal_ctrl1_t, *psyson_sys_xtal_ctrl1_t;

/**
  \brief Union type to access syson_sys_xtal_ctrl2 (@ 0x00000068).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x00000068) System XTAL Control Register2                              */
  ...
  } b;                                        /*!< bit fields for syson_sys_xtal_ctrl2 */
} syson_sys_xtal_ctrl2_t, *psyson_sys_xtal_ctrl2_t;

/**
  \brief Union type to access syson_sys_xtal_aac_ctrl (@ 0x0000006C).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x0000006C) System XTAL AAC Control Register                           */
  ...
  } b;                                        /*!< bit fields for syson_sys_xtal_aac_ctrl */
} syson_sys_xtal_aac_ctrl_t, *psyson_sys_xtal_aac_ctrl_t;

/**
  \brief Union type to access syson_sys_pll_ctrl0 (@ 0x00000070).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x00000070) System PLL Control Register0                               */
  ...
  } b;                                        /*!< bit fields for syson_sys_pll_ctrl0 */
} syson_sys_pll_ctrl0_t, *psyson_sys_pll_ctrl0_t;

/**
  \brief Union type to access syson_sys_pll_ctrl1 (@ 0x00000074).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x00000074) System PLL Control Register1                               */
  ...
  } b;                                        /*!< bit fields for syson_sys_pll_ctrl1 */
} syson_sys_pll_ctrl1_t, *psyson_sys_pll_ctrl1_t;

/**
  \brief Union type to access syson_sys_pll_ctrl2 (@ 0x00000078).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x00000078) System PLL Control Register2                               */
  ...
  } b;                                        /*!< bit fields for syson_sys_pll_ctrl2 */
} syson_sys_pll_ctrl2_t, *psyson_sys_pll_ctrl2_t;

/**
  \brief Union type to access syson_sys_pll_ctrl3 (@ 0x0000007C).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x0000007C) System PLL Control Register3                               */
  ...
  } b;                                        /*!< bit fields for syson_sys_pll_ctrl3 */
} syson_sys_pll_ctrl3_t, *psyson_sys_pll_ctrl3_t;

/**
  \brief Union type to access syson_osc128k_ctrl (@ 0x00000080).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x00000080) Osc128K Control Register                                   */
  ...
  } b;                                        /*!< bit fields for syson_osc128k_ctrl */
} syson_osc128k_ctrl_t, *psyson_osc128k_ctrl_t;

/**
  \brief Union type to access syson_sys_32k_sdm_idr_ctrl0 (@ 0x00000088).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x00000088) 32K SDM Indirrect Access Control Register0                 */
  ...
  } b;                                        /*!< bit fields for syson_sys_32k_sdm_idr_ctrl0 */
} syson_sys_32k_sdm_idr_ctrl0_t, *psyson_sys_32k_sdm_idr_ctrl0_t;

/**
  \brief Union type to access syson_sys_32k_sdm_idr_ctrl1 (@ 0x0000008C).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x0000008C) 32K SDM Indirrect Access Control Register1                 */
  
  struct {
    __IOM uint32_t ls_sdm_data : 32;          /*!< [31..0] SDM register data, support byte write                             */
  } b;                                        /*!< bit fields for syson_sys_32k_sdm_idr_ctrl1 */
} syson_sys_32k_sdm_idr_ctrl1_t, *psyson_sys_32k_sdm_idr_ctrl1_t;

/**
  \brief Union type to access syson_xtal_aac_dbg (@ 0x000000A0).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x000000A0) XTAL AAC Debugging Register                                */
  ...
  } b;                                        /*!< bit fields for syson_xtal_aac_dbg */
} syson_xtal_aac_dbg_t, *psyson_xtal_aac_dbg_t;

/**
  \brief Union type to access syson_sys_debug_reg (@ 0x000000A4).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x000000A4) System Debugging Register                                  */
  
  struct {
    __IM  uint32_t sys_dbg_value : 32;        /*!< [31..0] SYS debug register value. 0x30[7:0] select the debug
                                                   port                                                                      */
  } b;                                        /*!< bit fields for syson_sys_debug_reg */
} syson_sys_debug_reg_t, *psyson_sys_debug_reg_t;

/**
  \brief Union type to access syson_pad_ctrl (@ 0x000000AC).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x000000AC) IO Pad Control Register                                    */
  ...
  } b;                                        /*!< bit fields for syson_pad_ctrl */
} syson_pad_ctrl_t, *psyson_pad_ctrl_t;

/**
  \brief Union type to access syson_gpioa0_1_ctrl (@ 0x000000B0).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x000000B0) GPIOA0 and GPIOA1 Control Register                         */
  ...
  struct {
    ...
    __IOM uint32_t gpioa1_driving : 2;        /*!< [27..26] (E3,E2)=(10:9) 1.8V: 00: 2mA; 01: 4mA; 10: 6mA; 11:
                                                   8mA 3.3V: 00: 4mA; 01: 6mA; 10: 12mA; 11: 16mA                            */
  } b;                                        /*!< bit fields for syson_gpioa0_1_ctrl */
} syson_gpioa0_1_ctrl_t, *psyson_gpioa0_1_ctrl_t;

/**
  \brief Union type to access syson_gpioa2_3_ctrl (@ 0x000000B4).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x000000B4) GPIOA2 and GPIOA3 Control Register                         */
  ...
  struct {
    ...
    __IOM uint32_t gpioa3_driving : 2;        /*!< [27..26] (E3,E2)=(10:9) 1.8V: 00: 2mA; 01: 4mA; 10: 6mA; 11:
                                                   8mA 3.3V: 00: 4mA; 01: 6mA; 10: 12mA; 11: 16mA                            */
  } b;                                        /*!< bit fields for syson_gpioa2_3_ctrl */
} syson_gpioa2_3_ctrl_t, *psyson_gpioa2_3_ctrl_t;

/**
  \brief Union type to access syson_gpioa4_5_ctrl (@ 0x000000B8).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x000000B8) GPIO A4 and GPIO A5 Control Register                       */
  ...
  struct {
    ...
    __IOM uint32_t gpioa5_driving : 2;        /*!< [27..26] (E3,E2)=(10:9) 1.8V: 00: 2mA; 01: 4mA; 10: 6mA; 11:
                                                   8mA 3.3V: 00: 4mA; 01: 6mA; 10: 12mA; 11: 16mA                            */
  } b;                                        /*!< bit fields for syson_gpioa4_5_ctrl */
} syson_gpioa4_5_ctrl_t, *psyson_gpioa4_5_ctrl_t;

/**
  \brief Union type to access syson_gpioa6_7_ctrl (@ 0x000000BC).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x000000BC) GPIO A6 and GPIO A7 Control Register                       */
  ...
  struct {
    ...
    __IOM uint32_t gpioa7_driving : 2;        /*!< [27..26] (E3,E2)=(10:9) 1.8V: 00: 2mA; 01: 4mA; 10: 6mA; 11:
                                                   8mA 3.3V: 00: 4mA; 01: 6mA; 10: 12mA; 11: 16mA                            */
  } b;                                        /*!< bit fields for syson_gpioa6_7_ctrl */
} syson_gpioa6_7_ctrl_t, *psyson_gpioa6_7_ctrl_t;

/**
  \brief Union type to access syson_gpioa8_9_ctrl (@ 0x000000C0).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x000000C0) GPIO A8 and GPIO A9 Control Register                       */
  ...
  struct {
    ...
    __IOM uint32_t gpioa9_driving : 2;        /*!< [27..26] (E3,E2)=(10:9) 1.8V: 00: 2mA; 01: 4mA; 10: 6mA; 11:
                                                   8mA 3.3V: 00: 4mA; 01: 6mA; 10: 12mA; 11: 16mA                            */
  } b;                                        /*!< bit fields for syson_gpioa8_9_ctrl */
} syson_gpioa8_9_ctrl_t, *psyson_gpioa8_9_ctrl_t;

/**
  \brief Union type to access syson_gpioa10_11_ctrl (@ 0x000000C4).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x000000C4) GPIO A10 and GPIO A11 Control Register                     */
  ...
  struct {
    ...
    __IOM uint32_t gpioa11_driving : 2;       /*!< [27..26] (E3,E2)=(10:9) 1.8V: 00: 2mA; 01: 4mA; 10: 6mA; 11:
                                                   8mA 3.3V: 00: 4mA; 01: 6mA; 10: 12mA; 11: 16mA                            */
  } b;                                        /*!< bit fields for syson_gpioa10_11_ctrl */
} syson_gpioa10_11_ctrl_t, *psyson_gpioa10_11_ctrl_t;

/**
  \brief Union type to access syson_gpioa12_13_ctrl (@ 0x000000C8).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x000000C8) GPIO A12 and GPIO A13 Control Register                     */
  ...
  } b;                                        /*!< bit fields for syson_gpioa12_13_ctrl */
} syson_gpioa12_13_ctrl_t, *psyson_gpioa12_13_ctrl_t;

/**
  \brief Union type to access syson_gpioa14_15_ctrl (@ 0x000000CC).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x000000CC) GPIO A14 and GPIO A15 Control Register                     */
  ...
  struct {
    ...
    __IOM uint32_t gpioa15_driving : 2;       /*!< [27..26] (E3,E2)=(10:9) 1.8V: 00: 2mA; 01: 4mA; 10: 6mA; 11:
                                                   8mA 3.3V: 00: 4mA; 01: 6mA; 10: 12mA; 11: 16mA                            */
  } b;                                        /*!< bit fields for syson_gpioa14_15_ctrl */
} syson_gpioa14_15_ctrl_t, *psyson_gpioa14_15_ctrl_t;

/**
  \brief Union type to access syson_gpioa16_17_ctrl (@ 0x000000D0).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x000000D0) GPIO A16 and GPIO A17 Control Register                     */
  ...
  struct {
    ...
    __IOM uint32_t gpioa17_driving : 2;       /*!< [27..26] (E3,E2)=(10:9) 1.8V: 00: 2mA; 01: 4mA; 10: 6mA; 11:
                                                   8mA 3.3V: 00: 4mA; 01: 6mA; 10: 12mA; 11: 16mA                            */
  } b;                                        /*!< bit fields for syson_gpioa16_17_ctrl */
} syson_gpioa16_17_ctrl_t, *psyson_gpioa16_17_ctrl_t;

/**
  \brief Union type to access syson_gpioa18_19_ctrl (@ 0x000000D4).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x000000D4) GPIO A18 and GPIO A19 Control Register                     */
  ...
  struct {
    ...
    __IOM uint32_t gpioa19_driving : 2;       /*!< [27..26] (E3,E2)=(10:9) 1.8V: 00: 2mA; 01: 4mA; 10: 6mA; 11:
                                                   8mA 3.3V: 00: 4mA; 01: 6mA; 10: 12mA; 11: 16mA                            */
  } b;                                        /*!< bit fields for syson_gpioa18_19_ctrl */
} syson_gpioa18_19_ctrl_t, *psyson_gpioa18_19_ctrl_t;

/**
  \brief Union type to access syson_gpioa20_21_ctrl (@ 0x000000D8).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x000000D8) GPIO A20 and GPIO A21 Control Register                     */
  ...
  struct {
    ...
    __IOM uint32_t gpioa21_driving : 2;       /*!< [27..26] (E3,E2)=(10:9) 1.8V: 00: 2mA; 01: 4mA; 10: 6mA; 11:
                                                   8mA 3.3V: 00: 4mA; 01: 6mA; 10: 12mA; 11: 16mA                            */
  } b;                                        /*!< bit fields for syson_gpioa20_21_ctrl */
} syson_gpioa20_21_ctrl_t, *psyson_gpioa20_21_ctrl_t;

/**
  \brief Union type to access syson_gpioa22_23_ctrl (@ 0x000000DC).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x000000DC) GPIO A22 and GPIO A23 Control Register                     */
  ...
  struct {
    ...
    __IOM uint32_t gpioa23_driving : 2;       /*!< [27..26] (E3,E2)=(10:9) 1.8V: 00: 2mA; 01: 4mA; 10: 6mA; 11:
                                                   8mA 3.3V: 00: 4mA; 01: 6mA; 10: 12mA; 11: 16mA                            */
  } b;                                        /*!< bit fields for syson_gpioa22_23_ctrl */
} syson_gpioa22_23_ctrl_t, *psyson_gpioa22_23_ctrl_t;

/**
  \brief Union type to access syson_sys_eeprom_ctrl0 (@ 0x000000E0).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x000000E0) System EEPROM Control Register                             */
  ...
  } b;                                        /*!< bit fields for syson_sys_eeprom_ctrl0 */
} syson_sys_eeprom_ctrl0_t, *psyson_sys_eeprom_ctrl0_t;

/**
  \brief Union type to access syson_sys_efuse_ctrl (@ 0x000000E8).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x000000E8) System eFuse Control Register                              */
  ...
  } b;                                        /*!< bit fields for syson_sys_efuse_ctrl */
} syson_sys_efuse_ctrl_t, *psyson_sys_efuse_ctrl_t;

/**
  \brief Union type to access syson_sys_efuse_test (@ 0x000000EC).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x000000EC) eFuse Test Register                                        */
  ...
  } b;                                        /*!< bit fields for syson_sys_efuse_test */
} syson_sys_efuse_test_t, *psyson_sys_efuse_test_t;

/**
  \brief Union type to access syson_sys_sw_reserv0 (@ 0x000000F0).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x000000F0) SW reserved Register0                                      */
  
  struct {
    __IOM uint32_t sw_resv0   : 32;           /*!< [31..0] SW reserved register0                                             */
  } b;                                        /*!< bit fields for syson_sys_sw_reserv0 */
} syson_sys_sw_reserv0_t, *psyson_sys_sw_reserv0_t;

/**
  \brief Union type to access syson_sys_sw_reserv1 (@ 0x000000F4).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x000000F4) SW reserved Register1                                      */
  
  struct {
    __IOM uint32_t sw_resv1   : 32;           /*!< [31..0] SW reserved register1                                             */
  } b;                                        /*!< bit fields for syson_sys_sw_reserv1 */
} syson_sys_sw_reserv1_t, *psyson_sys_sw_reserv1_t;

/**
  \brief Union type to access syson_sys_sw_reserv2 (@ 0x000000F8).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x000000F8) SW reserved Register2                                      */
  
  struct {
    __IOM uint32_t sw_resv2   : 32;           /*!< [31..0] SW reserved register2                                             */
  } b;                                        /*!< bit fields for syson_sys_sw_reserv2 */
} syson_sys_sw_reserv2_t, *psyson_sys_sw_reserv2_t;

/**
  \brief Union type to access syson_sys_sw_reserv3 (@ 0x000000FC).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x000000FC) SW reserved Register3                                      */
  
  struct {
    __IOM uint32_t sw_resv3   : 32;           /*!< [31..0] SW reserved register3                                             */
  } b;                                        /*!< bit fields for syson_sys_sw_reserv3 */
} syson_sys_sw_reserv3_t, *psyson_sys_sw_reserv3_t;

/**
  \brief Union type to access syson_sys_slp_wake_event_msk0 (@ 0x00000100).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x00000100) System Wake Up Event Mask Register                         */
  ...
  } b;                                        /*!< bit fields for syson_sys_slp_wake_event_msk0 */
} syson_sys_slp_wake_event_msk0_t, *psyson_sys_slp_wake_event_msk0_t;

/**
  \brief Union type to access syson_sys_slp_wake_event_status0 (@ 0x00000108).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x00000108) System Wake Up Event Status Register                       */
  ...
  } b;                                        /*!< bit fields for syson_sys_slp_wake_event_status0 */
} syson_sys_slp_wake_event_status0_t, *psyson_sys_slp_wake_event_status0_t;

/**
  \brief Union type to access syson_sys_snf_wake_event_status (@ 0x00000114).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x00000114) System Sniff Mode Wake Up Event Status Register            */
  
  struct {
    __IM  uint32_t            : 1;
    __IOM uint32_t syson_snfevt_wlon_pon_sts : 1;/*!< [1..1] 1: indicate wlan power on wakeup status                         */
  } b;                                        /*!< bit fields for syson_sys_snf_wake_event_status */
} syson_sys_snf_wake_event_status_t, *psyson_sys_snf_wake_event_status_t;

/**
  \brief Union type to access syson_sys_pwrmgt_ctrl (@ 0x00000118).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x00000118) System Power Management Register                           */
  ...
  } b;                                        /*!< bit fields for syson_sys_pwrmgt_ctrl */
} syson_sys_pwrmgt_ctrl_t, *psyson_sys_pwrmgt_ctrl_t;

/**
  \brief Union type to access syson_sys_pwrmgt_option (@ 0x00000120).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x00000120) System Power Management Option Register                    */
  ...
  } b;                                        /*!< bit fields for syson_sys_pwrmgt_option */
} syson_sys_pwrmgt_option_t, *psyson_sys_pwrmgt_option_t;

/**
  \brief Union type to access syson_sys_pwrmgt_option_ext (@ 0x00000124).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x00000124) System Power Management Extension Option Register          */
  ...
  } b;                                        /*!< bit fields for syson_sys_pwrmgt_option_ext */
} syson_sys_pwrmgt_option_ext_t, *psyson_sys_pwrmgt_option_ext_t;

/**
  \brief Union type to access syson_non_reset_ff (@ 0x00000138).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x00000138) non-Reset Flags                                            */
  ...
  } b;                                        /*!< bit fields for syson_non_reset_ff */
} syson_non_reset_ff_t, *psyson_non_reset_ff_t;

/**
  \brief Union type to access syson_gpiob0_1_ctrl (@ 0x00000150).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x00000150) GPIO B0 and GPIO B1 Control Register                       */
  ...
  struct {
    ...
    __IOM uint32_t gpiob1_driving : 2;        /*!< [27..26] (E3,E2)=(10:9) 1.8V: 00: 2mA; 01: 4mA; 10: 6mA; 11:
                                                   8mA 3.3V: 00: 4mA; 01: 6mA; 10: 12mA; 11: 16mA                            */
  } b;                                        /*!< bit fields for syson_gpiob0_1_ctrl */
} syson_gpiob0_1_ctrl_t, *psyson_gpiob0_1_ctrl_t;

/**
  \brief Union type to access syson_gpiob2_3_ctrl (@ 0x00000154).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x00000154) GPIO B2 and GPIO B3 Control Register                       */
  ...
  struct {
    ...
    __IOM uint32_t gpiob3_driving : 2;        /*!< [27..26] (E3,E2)=(10:9) 1.8V: 00: 2mA; 01: 4mA; 10: 6mA; 11:
                                                   8mA 3.3V: 00: 4mA; 01: 6mA; 10: 12mA; 11: 16mA                            */
  } b;                                        /*!< bit fields for syson_gpiob2_3_ctrl */
} syson_gpiob2_3_ctrl_t, *psyson_gpiob2_3_ctrl_t;

/**
  \brief Union type to access syson_gpiob4_5_ctrl (@ 0x00000158).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x00000158) GPIO B4 and GPIO B5 Control Register                       */
  ...
  struct {
    ...
    __IOM uint32_t gpiob5_driving : 2;        /*!< [27..26] (E3,E2)=(10:9) 1.8V: 00: 2mA; 01: 4mA; 10: 6mA; 11:
                                                   8mA 3.3V: 00: 4mA; 01: 6mA; 10: 12mA; 11: 16mA                            */
  } b;                                        /*!< bit fields for syson_gpiob4_5_ctrl */
} syson_gpiob4_5_ctrl_t, *psyson_gpiob4_5_ctrl_t;

/**
  \brief Union type to access syson_gpiob6_7_ctrl (@ 0x0000015C).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x0000015C) GPIO B6 and GPIO B7 Control Register                       */
  ...
  struct {
    ...
    __IOM uint32_t gpiob7_driving : 2;        /*!< [27..26] (E3,E2)=(10:9) 1.8V: 00: 2mA; 01: 4mA; 10: 6mA; 11:
                                                   8mA 3.3V: 00: 4mA; 01: 6mA; 10: 12mA; 11: 16mA                            */
  } b;                                        /*!< bit fields for syson_gpiob6_7_ctrl */
} syson_gpiob6_7_ctrl_t, *psyson_gpiob6_7_ctrl_t;

/**
  \brief Union type to access syson_gpiob8_9_ctrl (@ 0x00000160).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x00000160) GPIO B8 and GPIO B9 Control Register                       */
  ...
  struct {
    ...
    __IOM uint32_t gpiob9_driving : 2;        /*!< [27..26] (E3,E2)=(10:9) 1.8V: 00: 2mA; 01: 4mA; 10: 6mA; 11:
                                                   8mA 3.3V: 00: 4mA; 01: 6mA; 10: 12mA; 11: 16mA                            */
  } b;                                        /*!< bit fields for syson_gpiob8_9_ctrl */
} syson_gpiob8_9_ctrl_t, *psyson_gpiob8_9_ctrl_t;

/**
  \brief Union type to access syson_gpiob10_11_ctrl (@ 0x00000164).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x00000164) GPIO B10 and GPIO B11 Control Register                     */
  ...
  struct {
    ...
    __IOM uint32_t gpiob11_driving : 2;       /*!< [27..26] (E3,E2)=(10:9) 1.8V: 00: 2mA; 01: 4mA; 10: 6mA; 11:
                                                   8mA 3.3V: 00: 4mA; 01: 6mA; 10: 12mA; 11: 16mA                            */
  } b;                                        /*!< bit fields for syson_gpiob10_11_ctrl */
} syson_gpiob10_11_ctrl_t, *psyson_gpiob10_11_ctrl_t;

/**
  \brief Union type to access syson_gpiob12_ctrl (@ 0x00000168).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x00000168) GPIO B10 and GPIO B11 Control Register                     */
  ...
  struct {
    ...
    __IOM uint32_t gpiob12_driving : 2;       /*!< [11..10] (E3,E2)=(10:9) 1.8V: 00: 2mA; 01: 4mA; 10: 6mA; 11:
                                                   8mA 3.3V: 00: 4mA; 01: 6mA; 10: 12mA; 11: 16mA                            */
  } b;                                        /*!< bit fields for syson_gpiob12_ctrl */
} syson_gpiob12_ctrl_t, *psyson_gpiob12_ctrl_t;

/**
  \brief Union type to access syson_test_ctrl (@ 0x000001E8).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x000001E8) Test Control Register                                      */
  ...
  } b;                                        /*!< bit fields for syson_test_ctrl */
} syson_test_ctrl_t, *psyson_test_ctrl_t;

/**
  \brief Union type to access syson_test_mux_ctrl (@ 0x000001EC).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x000001EC) Test Mux Control Register                                  */
  ...
  } b;                                        /*!< bit fields for syson_test_mux_ctrl */
} syson_test_mux_ctrl_t, *psyson_test_mux_ctrl_t;

/**
  \brief Union type to access syson_sys_system_cfg0 (@ 0x000001F0).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x000001F0) System Configuration Register0                             */
  ...
  struct {
    ...
    __IM  uint32_t syscfg_bd_pkg_sel : 1;     /*!< [31..31] Trapped PKG_ENG_SEL value 0: normal package; 1: engineering
                                                   mode                                                                      */
  } b;                                        /*!< bit fields for syson_sys_system_cfg0 */
} syson_sys_system_cfg0_t, *psyson_sys_system_cfg0_t;

/**
  \brief Union type to access syson_sys_system_cfg1 (@ 0x000001F4).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x000001F4) System Configuration Register1                             */
  ...
  struct {
    ...
    __IM  uint32_t syscfg_trp_test_mode_sel : 1;/*!< [26..26] Trapped Selection for Test mode 0: normal mode; 1:
                                                   test mode                                                                 */
  } b;                                        /*!< bit fields for syson_sys_system_cfg1 */
} syson_sys_system_cfg1_t, *psyson_sys_system_cfg1_t;

/**
  \brief Union type to access syson_sys_system_cfg2 (@ 0x000001F8).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x000001F8) System Configuration Register2                             */
  
  struct {
    __IOM uint32_t syscfg_rom_info : 8;       /*!< [7..0] ROM Information                                                    */
  } b;                                        /*!< bit fields for syson_sys_system_cfg2 */
} syson_sys_system_cfg2_t, *psyson_sys_system_cfg2_t;

/**
  \brief Union type to access syson_platform_cfg (@ 0x0000020C).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x0000020C) Platform Configuration Register                            */
  ...
  } b;                                        /*!< bit fields for syson_platform_cfg */
} syson_platform_cfg_t, *psyson_platform_cfg_t;

/**
  \brief Union type to access syson_soc_func_en (@ 0x00000210).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x00000210) SOC Function Enable Control Register                       */
  ...
  } b;                                        /*!< bit fields for syson_soc_func_en */
} syson_soc_func_en_t, *psyson_soc_func_en_t;

/**
  \brief Union type to access syson_soc_hci_com_func_en (@ 0x00000214).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x00000214) SOC HCI Function Enable Control Register                   */
  ...
  } b;                                        /*!< bit fields for syson_soc_hci_com_func_en */
} syson_soc_hci_com_func_en_t, *psyson_soc_hci_com_func_en_t;

/**
  \brief Union type to access syson_soc_peri_func0_en (@ 0x00000218).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x00000218) SOC Peripheral Function Enable Control Register0           */
  ...
  } b;                                        /*!< bit fields for syson_soc_peri_func0_en */
} syson_soc_peri_func0_en_t, *psyson_soc_peri_func0_en_t;

/**
  \brief Union type to access syson_soc_peri_func1_en (@ 0x0000021C).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x0000021C) SOC Peripheral Function Enable Control Register1           */
  
  struct {
    __IM  uint32_t            : 12;
    __IOM uint32_t pwm_en     : 1;            /*!< [12..12] 1: enable PWM function                                           */
    __IOM uint32_t pwm_int_clk_sel : 1;       /*!< [13..13] 0: APB CLK; 1: TIMER CLK                                         */
  } b;                                        /*!< bit fields for syson_soc_peri_func1_en */
} syson_soc_peri_func1_en_t, *psyson_soc_peri_func1_en_t;

/**
  \brief Union type to access syson_soc_peri_bd_func0_en (@ 0x00000220).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x00000220) SOC Peripheral Bus Domain Function Enable Control
                                                                  Register                                                   */
  ...
  } b;                                        /*!< bit fields for syson_soc_peri_bd_func0_en */
} syson_soc_peri_bd_func0_en_t, *psyson_soc_peri_bd_func0_en_t;

/**
  \brief Union type to access syson_pesoc_clk_ctrl (@ 0x00000230).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x00000230) Peripheral Clock Enable Control Register                   */
  ...
  } b;                                        /*!< bit fields for syson_pesoc_clk_ctrl */
} syson_pesoc_clk_ctrl_t, *psyson_pesoc_clk_ctrl_t;

/**
  \brief Union type to access syson_pesoc_peri_clk_ctrl0 (@ 0x00000234).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x00000234) Peripheral Clock Enable Control Register0                  */
  ...
  } b;                                        /*!< bit fields for syson_pesoc_peri_clk_ctrl0 */
} syson_pesoc_peri_clk_ctrl0_t, *psyson_pesoc_peri_clk_ctrl0_t;

/**
  \brief Union type to access syson_pesoc_peri_clk_ctrl1 (@ 0x00000238).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x00000238) Peripheral Clock Enable Control Register1                  */
  
  struct {
    __IOM uint32_t soc_sclk_i2c0_en : 1;      /*!< [0..0] 1: enable I2C0 ic_clk                                              */
    __IOM uint32_t soc_pclk_i2c0_en : 1;      /*!< [1..1] 1; enable I2C0 pclock                                              */
  } b;                                        /*!< bit fields for syson_pesoc_peri_clk_ctrl1 */
} syson_pesoc_peri_clk_ctrl1_t, *psyson_pesoc_peri_clk_ctrl1_t;

/**
  \brief Union type to access syson_pesoc_hci_clk_ctrl0 (@ 0x00000240).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x00000240) Peripheral HCI Clock Enable Control Register               */
  ...
  } b;                                        /*!< bit fields for syson_pesoc_hci_clk_ctrl0 */
} syson_pesoc_hci_clk_ctrl0_t, *psyson_pesoc_hci_clk_ctrl0_t;

/**
  \brief Union type to access syson_pesoc_com_clk_ctrl1 (@ 0x00000244).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x00000244) SOC Common Clock Enable Control Register                   */
  ...
  } b;                                        /*!< bit fields for syson_pesoc_com_clk_ctrl1 */
} syson_pesoc_com_clk_ctrl1_t, *psyson_pesoc_com_clk_ctrl1_t;

/**
  \brief Union type to access syson_pesoc_clk_sel (@ 0x00000250).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x00000250) Peripheral Clock Selection Register                        */
  
  struct {
    __IM  uint32_t            : 16;
    __IOM uint32_t pesoc_ck_scale : 2;        /*!< [17..16] PLL clock divided by N: 2b'00: N=1, 2b'01: N=2 (/2),
                                                   2b'02: N=4 (/4)                                                           */
  } b;                                        /*!< bit fields for syson_pesoc_clk_sel */
} syson_pesoc_clk_sel_t, *psyson_pesoc_clk_sel_t;

/**
  \brief Union type to access syson_pesoc_peri_ctrl (@ 0x00000308).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x00000308) SOC Peripheral Control Register                            */
  
  struct {
    __IM  uint32_t            : 8;
    __IOM uint32_t soc_func_spi_rn : 1;       /*!< [8..8] 1: master 0: slave                                                 */
  } b;                                        /*!< bit fields for syson_pesoc_peri_ctrl */
} syson_pesoc_peri_ctrl_t, *psyson_pesoc_peri_ctrl_t;

/**
  \brief Union type to access syson_rm_cfg0 (@ 0x00000320).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x00000320) Read Margin Configuration Register0                        */
  ...
  } b;                                        /*!< bit fields for syson_rm_cfg0 */
} syson_rm_cfg0_t, *psyson_rm_cfg0_t;

/**
  \brief Union type to access syson_rm_cfg1 (@ 0x00000324).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x00000324) Read Margin Configuration Register1                        */
  ...
  } b;                                        /*!< bit fields for syson_rm_cfg1 */
} syson_rm_cfg1_t, *psyson_rm_cfg1_t;

/**
  \brief Union type to access syson_rme_cfg (@ 0x00000328).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x00000328) Read Margin Enable Configuration Register                  */
  ...
  } b;                                        /*!< bit fields for syson_rme_cfg */
} syson_rme_cfg_t, *psyson_rme_cfg_t;

/**
  \brief Union type to access syson_peon_status (@ 0x000003F4).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x000003F4) Peripheral On Status Register                              */
  
  struct {
    __IOM uint32_t peon_sdio_aldn : 1;        /*!< [0..0] 1: SDIO Config autoload done; 0: autoload not ready                */
  } b;                                        /*!< bit fields for syson_peon_status */
} syson_peon_status_t, *psyson_peon_status_t;
...
#endif    // end of #ifndef _RTL8710C_SYSON_SYSON_TYPE_H_
