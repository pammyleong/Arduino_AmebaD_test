...
typedef union {
  ...
  struct {
    __IM  uint32_t gdma0_ch0_isr : 1;         /*!< [0..0] GDMA0 Channel 0 interrupt pending status.                          */
    __IM  uint32_t gdma0_ch1_isr : 1;         /*!< [1..1] GDMA0 Channel 1 interrupt pending status.                          */
...
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x00000034) UART Interrupt Pending Status Register                     */
  
  struct {
    __IM  uint32_t uart2_isr  : 1;            /*!< [0..0] UART2 interrupt pending status                                     */
    __IM  uint32_t uart1_isr  : 1;            /*!< [1..1] UART1 interrupt pending status                                     */
    __IM  uint32_t uart0_isr  : 1;            /*!< [2..2] UART0 interrupt pending status                                     */
    __IM  uint32_t uart3_isr  : 1;            /*!< [3..3] UART3 interrupt pending status                                     */
