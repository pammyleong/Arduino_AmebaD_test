...
typedef union {
  ...
  struct {
    __IM  uint32_t gdma0_ch0_isr : 1;         /*!< [0..0] Secure GDMA channel 0 interrupt pending status                     */
    __IM  uint32_t gdma0_ch1_isr : 1;         /*!< [1..1] Secure GDMA channel 1 interrupt pending status                     */
  } b;                                        /*!< bit fields for vdr_s_secure_gdma0_isr */
} vdr_s_secure_gdma0_isr_t, *pvdr_s_secure_gdma0_isr_t;
