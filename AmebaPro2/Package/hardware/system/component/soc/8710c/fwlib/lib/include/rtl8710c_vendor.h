...
#ifndef RTL8710C_VENDOR_H
#define RTL8710C_VENDOR_H
...
typedef struct {                                /*!< (@ 0x40002800) VDR Structure                                              */
  ...
  union {
    __IM  uint32_t gdma0_isr;                   /*!< (@ 0x00000030) GDMA Interrupt Status Register                             */
  ...
  union {
    __IM  uint32_t uart_isr;                    /*!< (@ 0x00000034) UART Interrupt Pending Status Register                     */
...
typedef struct {                                /*!< (@ 0x50002C00) VDR_S Structure                                            */
  ...
  union {
    __IM  uint32_t secure_gdma0_isr;            /*!< (@ 0x00000010) Secure GDMA Interrupt Pending Status Register              */
...
#include "rtl8710c_vdr_type.h"
#include "rtl8710c_vdr_s_type.h"
