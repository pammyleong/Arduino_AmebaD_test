 ...
 *
 * Removes the callback structure to the list of callback structures for periodic
 * adverising syncs.
 *
 * @param cb Callback struct. Must point to memory that remains valid.
 */
...
/**
 * @brief Reset periodic advertising sync callbacks.
 *
 * Reset the list of callback structures for periodic adverising syncs.
 *
 */
void bt_le_per_adv_sync_cb_reset(void);
 ...
 *
 * Removes the callback structure to the list of callback structures that monitors
 * scanner activity.
 *
 * This callback will be called for all scanner activity, regardless of what
 * API was used to start the scanner.
...
/**
 * @brief Reset scanner packet callbacks.
 *
 * Reset the list of scanner callbacks.
 *
 */
void bt_le_scan_cb_reset(void);
