...
#define BTC_BCN_EARLY               DEFAULT_PS_DRV_EARLY + 1
...
typedef enum _C2H_BT_INFO_ {
	_RSP_WIFI_FW             = 0,
	_RSP_WIFI_REQ            = 1,
	_RSP_BT_CHANGE_STS       = 2,
	_RSP_BT_IQK              = 3,
	_RSP_BT_SB               = 4,
	_RSP_BT_RPT_TDMA         = 5,
	_RSP_BT_PSD_REPORT       = 6,
	_RSP_BT_SLOT_LENGTH      = 7
...
/***************************ROM function patch*********************************/
extern void
BTRoleChangeTimerHDL_8721D_RAM(
	void
);

extern void
BTRoleChangeTBTTHDL_8721D_RAM(
	void
);

#if 0
extern void
FillMailbox_8721D_RAM(
	IN  u8 cmd,
	IN  u8 length,
	IN  u8 *pparm
);
...
extern void
MailboxINTHDL_8721D_RAM(
	void
);

extern void
BTMailboxRetry_8721D_RAM(
	void
);
#endif

extern BOOLEAN
FillMailboxNew_8730A(
	IN  u8 cmd,
	IN  u8 length,
	IN  u8 *pparm
);
...
extern void
BT2WLMailboxINTHDL_8730A(
	void
);

extern void
BT2WLMailboxINTCheck_8730A(
	void
);

extern void
H2CHDL_BTInfo_8721D_RAM(
	IN  u8  *pbuf
);

extern void
H2CHDL_ForceBTTxpwr_8721D_RAM(
	IN  u8  *pbuf
);

extern void
H2CHDL_BTIgnoreWlanAct_8721D_RAM(
	IN  u8   *pbuf
);

#if 0
extern void
H2CHDL_DACSwingValue_8721D_RAM(
	IN  u8   *pbuf
);
#endif

extern void
H2CHDL_AntSelReverse_8721D_RAM(
	IN  u8   *pbuf
);

extern void
H2CHDL_WLOpmode_8721D_RAM(
	IN  u8   *pbuf
);

extern void
H2CHDL_BTMpH2C_8721D_RAM(
	IN  u8   *pbuf
);

extern void
H2CHDL_BTControl_8721D_RAM(
	IN  u8   *pbuf
);

extern void
H2CHDL_BTWifiCtrl_8721D_RAM(
	IN  u8  *pbuf
);

extern void
H2CHDL_BT_Page_Scan_Interval_8721D_RAM(
	u8 *pbuf
);

extern void
H2CHDL_WLCalibration_8721D_RAM(
	u8 *pbuf
);

extern void
H2CHDL_GNT_BT_CTRL_8721D_RAM(
	u8 *pbuf
);

extern void
H2CHDL_BT_ONLY_TEST_8721D_RAM(
	u8 *pbuf
);

extern void
H2CHDL_BT_Init_Param_8721D_RAM(
	u8 *pbuf
);
...
extern void
C2HBTLoopback_8721D_RAM(
	IN  u8  *pbuf
);

extern void
C2HBTMpRpt_8721D_RAM(
	IN  u8  idx,
	IN  u8  status,
	IN  u8  req_num
);
...
#if 0
extern void
InitBTypeTDMA2_8721D_RAM(
	void
);
#endif

extern void
InitBTCoexTimer_8721D_RAM(
	IN  u8 duration
);
...
extern void
TdmaChangeCoexTable_8730A(
	IN  u8  slot
);

extern void
BTNullSetting_8721D_RAM(
	IN  u8  bPowerBit,
	IN  u16 offset,
	IN  u8  lsb,
	IN  u8  msb
...
#if 0
extern void
WlanActCtrl_8721D_RAM(
	void
);
#endif

extern void
BT_TDMA_Slot_Operation_0and3_8721D_RAM(
	IN	u8	slot_num
);

extern void
BT_TDMA_Slot_Operation_1and4_8721D_RAM(
	IN	u8	slot_num
);

extern void
BT_TDMA_Slot_Operation_2and5_8721D_RAM(
	IN	u8	slot_num
);

#if 0
extern void
FlexibleExtensionDecision_8721D_RAM(
	void
);

extern void
BTypeTDMABCNEarly_8721D_RAM(
	void
);

extern void
BTypeTDMATBTThdl_8721D_RAM(
	void
);
#endif

extern u8
DynamicSlotDecision_8730A(
	void
);

extern void
BTypeTDMABCNEarlyNew_8730A(
	IN  u8  type
);

extern void
BTypeTDMATBTThdlNew_8730A(
	IN  u8  type
);

extern void
BTypeTDMATimeOuthdl_8721D_RAM(
	void
);

extern void
H2CHDL_WL_Port_ID_8730A(
	u8 *pbuf
);

extern void
BTRoleChangeDefaultSettingNew_8730A(
	void
);

extern void
BTC_BackupAntennaSettingNew_8730A(
	IN  u8  option
);

extern void
COEX_GPIOCtrl(u32 GPIO_Pin, u32 Val);

extern void
H2CHDL_BTPSTDMANew_8730A(
	IN  u8  *pbuf
);

extern void
BTC_PsTdmaActionDelay_8730A(
	void
);

extern void
BTC_PsTdmaAction_8730A(
	IN  u8  *pbuf
);
...
extern void
InitBTScoreboard_8730A(
	void
);

extern u8
BTypeTDMAMultiSlots_8730A(
	void
);

extern void
BTypeTDMALeakAPOperation_8730A(
	void
);

extern void
BTC_RestoreDefaultCoexTable_8730A(
	void
);

extern void
BTC_PWRBitOverWrite_8730A(
	IN  u8  PortNum,
	IN  u8  mode
);

extern void
BTC_PsTdmaIssueNull_8730A(
	BOOLEAN Powerbit,
	u8 PortNum
);

extern void
BTC_PsTdmaIssuePsPoll_8730A(
	void
);

extern void
BTC_PsTdmaOnBcn_8730A(
	void
);

extern void
BTC_BtIqkAction_8730A(
	IN  u8  allow
);

extern BOOLEAN
BTC_BtIqkCheck_8730A(
	void
);

extern void
BTC_WlanInfoCounterReset_8730A(
	void
);

extern BOOLEAN
BTC_ProceedBtSlot_8730A(
	void
);

extern void
BTC_ProtectBCN_8730A(
	void
);

extern void
BTC_RestoreBtSlot_8730A(
	void
);

extern u8
BTC_GenRandomValue_8730A(
	u8 range, u8 count
);

extern void
BTC_WifiRandomSlot_8730A(
	void
);

extern void
InitBTCoexGpioDebug_8730A(
	void
);

extern void
BTC_AOACSwitch_8730A(
	IN  u8  state
);
