...
//#define TSFIS32K                        1
//#define TSFIS40M                        0
//#define GET_TSF_STATE() ((ReadMACRegByte(REG_TSF_CLK_STATE +1) & CLK_STABLE_32K) ? TSFIS32K : TSFIS40M)
...
extern BOOLEAN
WaitTxStateMachineOk_8721D_RAM(
	void
);

extern void
WriteTxPause_8721D_RAM(
	IN u8 value,
	IN u8 rcode
) ;

extern void
SetTxPauseFWInfo_8721D(
	IN u8 BitMask,
	IN u8 UserValue
);

extern void
WriteTxPauseWithMask_8721D_RAM(
	IN u8 mask,
	IN u8 value,
	IN u8 rcode
);
