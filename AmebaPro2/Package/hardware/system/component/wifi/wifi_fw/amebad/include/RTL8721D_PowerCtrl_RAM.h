...
typedef struct _RF_PG_Parm_ {
	u8 DPK_RS_Flag1;
	u8 DPK_RS_Flag2;

	u32 IQK_X_backup ;
	u32 IQK_Y_backup ;
	u32 Predidtortion_BC;
	u32 PM_scan;
	u32 PA_Predistortion;
	u32 BypassDPD;
	u32 PWFS_Bnd;
	u32 GainScaling;
	u32 LUT_SRAM;
...
} RF_PG_Parm, *PRF_PG_Parm;

typedef struct _BB_PG_Parm_ {
	u32 C94_BackUp ;
	u32 C80_BackUp ;

} BB_PG_Parm, *PBB_PG_Parm;

typedef struct _RA_PG_Parm_ {
	u8 RA_BackUp[7];
	u8 RPT_BandWidth[MACID_NUM];
	u8 RPT_DataRate[MACID_NUM];

} RA_PG_Parm, *PRA_PG_Parm;
