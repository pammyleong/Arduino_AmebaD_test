...
/* Macro for Chip */
#define IS_CHIP_8730A(CurSel)       ( ((CurSel) & RTLCHIP_MASK) == RTL8730A_CHIP )
...
#define IS_CHIP_RF_N(CurSel)        (( ((CurSel) & RTLCHIP_MASK) == RTL8188E_CHIP ) \
                                    ...
                                    || ( ((CurSel) & RTLCHIP_MASK) == RTL8730A_CHIP )\
...
/* RTL8730A */
#define RTL8730A_TEST_CHIP_S             (RTL8730A_CHIP  | CHIPCUT_TEST | CHIP_FOUNDRY_SMIC)
#define RTL8730A_A_CUT_S                 (RTL8730A_CHIP  | CHIPCUT_A    | CHIP_FOUNDRY_SMIC)
#define RTL8730A_B_CUT_S                 (RTL8730A_CHIP  | CHIPCUT_B    | CHIP_FOUNDRY_SMIC)
