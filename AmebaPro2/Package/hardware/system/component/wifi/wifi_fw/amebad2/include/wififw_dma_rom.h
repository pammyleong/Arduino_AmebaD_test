#ifndef __WIFIFW_DMA_H__
#define __WIFIFW_DMA_H__
...
extern BOOLEAN InitDDMA_8730A_ROM(u8  ch_num,  u32 saddr,  u32 daddr,  u32 dma_size, BOOLEAN chksum_en);
extern BOOLEAN WaitDDMARDY_8730A_ROM(u8 ch_num);
extern BOOLEAN ChkDDMAChksum_8730A_ROM(u8 ch_num);
extern BOOLEAN CheckDDMADone_8730A_ROM(u8 ch_num, u8 chk_chksum);
