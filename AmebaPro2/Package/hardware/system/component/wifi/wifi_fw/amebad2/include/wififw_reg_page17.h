...
#define BIT_MASK_R2T_SIFS_CCK               ((u32)0x00000FFF << 12)          /*!<R/W 0x46  This register sets the SIFS time required for any immediate response for example Data-Ack. It is in unit of 100ns.(default:7.1us) */
#define BIT_R2T_SIFS_CCK(x)                 ((u32)(((x) & 0x00000FFF) << 12))
#define BIT_GET_R2T_SIFS_CCK(x)             ((u32)(((x >> 12) & 0x00000FFF)))
#define BIT_MASK_T2T_SIFS_CCK               ((u32)0x00000FFF << 0)          /*!<R/W 0x46  This register sets the SIFS time required for consecutive TX events for example CTS-Data, or broadcast bursting. It is in unit of 100ns.(default:7.1us) */
