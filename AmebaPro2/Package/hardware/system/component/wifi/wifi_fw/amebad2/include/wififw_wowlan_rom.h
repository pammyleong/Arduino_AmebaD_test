...
extern u8 CheckIV_8730A_ROM(u8 *IVToCheck, u8 raaddr, BOOLEAN unicast_check);
extern u8 DropCHK_8730A_ROM(void);
extern BOOLEAN WaitRXDMAIdle_8730A_ROM(void);
extern void EnableWoWLAN_8730A_ROM(void);
extern void DisWoWLAN_8730A_ROM(void);
extern BOOLEAN DropDecision_8730A_ROM(void);
extern void FwDisConnectWakeUpHost_8730A_ROM(IN u8 type);
extern BOOLEAN Ipv4Match_8730A_ROM(u16 addrl_frame_ctrl, u8 macHeaderLen);
extern BOOLEAN MatchUnicastFilter_8730A_ROM(u16 addrl_frame_ctrl, u8 macHeaderLen);
extern BOOLEAN WakeUpHostDecision_8730A_ROM(u8 RxDescWakeReason, u8 CheckMode);
extern BOOLEAN DestinationMatch_8730A_ROM(u16 addrl_frame_ctrl);
extern void UpdateRxFFReadPtr_DropPkt_8730A_ROM(u16 RPtr);
extern void H2CHDL_WoWLAN_8730A_ROM(u8 *pbuf);
extern void H2CHDL_AOACGlobalInfo_8730A_ROM(u8 *pbuf);
extern void H2CHDL_AOACRsvdpage1_8730A_ROM(u8 *pbuf);
extern void H2CHDL_AOACRsvdpage2_8730A_ROM(u8 *pbuf);
extern void H2CHDL_AOACRsvdpage3_8730A_ROM(u8 *pbuf);
extern void GetAddr_8730A_ROM(void);
extern void ARP_hdl_8730A_ROM(u8 bFunEnable);
extern void NDP_hdl_8730A_ROM(u8 bFunEnable);
extern BOOLEAN OnARP_8730A_ROM(u16 addrl_frame_ctrl, u8 MacHeaderLen);
extern void GetARPInfo_8730A_ROM(u8 pagenum);
extern void GetNDPInfo_8730A_ROM(u8 pagenum);
extern BOOLEAN OnNS_8730A_ROM(u16 addrl_frame_ctrl, u8 MacHeaderLen);
extern BOOLEAN IsIPV6_8730A_ROM(u16 addrl_frame_ctrl, u8 MacHeaderLen);
extern void PassSecurityInfoToDriver_8730A_ROM(u8 pagenum);
extern void GetRemoteControlInfo_8730A_ROM(u8 pagenum);
extern void InitDisconnectDecision_8730A_ROM(void);
extern void H2CHDL_DisconnectDecision_8730A_ROM(u8 *pbuf);
extern void InitKeepAlive_8730A_ROM(void);
extern void H2CHDL_KeepAlive_8730A_ROM(u8 *pbuf);
extern u16 PageOffsetAlignment_8730A_ROM(IN u16 offset);
extern void GetIV_8730A_ROM(u16 addrl_frame_ctrl, u8 MacHeaderLen, u8 IvLen, u8 *IV);
extern u8 GetIVLenAndSecurityType_8730A_ROM(u8 raaddr);
extern u8 GetMACHeaderLen_8730A_ROM(u8 macheader, u8 FrameCtrl, u8 raaddr);
extern void UpdateIV_8730A_ROM(u8 *buf, u8 retry_bit);
extern s8 RTmemcmpBackward_8730A_ROM(const void *Dest, const void *Src, u8 count);
extern u8 AesTkipIvCheck_8730A_ROM(u8 *rx_iv_ori, u8 *rx_iv, u8 SecurityType);
extern u8 WepIvCheck_8730A_ROM(u8 *rx_iv_ori, u8 *rx_iv);
extern void AssignIvToKeyRsc_8730A_ROM(u8 *pattrib_iv, u8 *KeyRsc, u8 *KeyID, u8 SecurityType);
extern void AssignKeyRscToIV_8730A_ROM(u8 *pattrib_iv, u8 *KeyRsc, u8 SecurityType);
extern void AesTkipIvFun_8730A_ROM(u8 *pattrib_iv, u8 RetryBit, u8 SecurityType);
extern void WepIvFun_8730A_ROM(u8 *iv, u8 retry_bit);
