#ifndef __WIFIFW_PACKET_H__
#define __WIFIFW_PACKET_H__
...
extern void ChangeTransmiteRate_8730A_ROM(u16 offset) ;
extern void PowerBitSetting_8730A_ROM(u8 bPowerBit, u16 offset);
extern void IssuePSPoll_8730A_ROM(void);
extern void ChkandChangePS_8730A_ROM(u8 bPowerBit);
extern void IssueQNull_8730A_ROM(u8 bPowerBit);
extern void CTS2SelfSetting_8730A_ROM(u16 offset, u16 NAV);
extern void IssueCTS2Self_8730A_ROM(u8 location, u16 NAV);
extern u16 IssueRsvdPagePacketSetting_8730A_ROM(u8 PageNum,  BOOLEAN bHwSEQEn,  u8 RtyLmt,  u8 TxInd);
extern u8 ReadRxBuff_8730A_ROM(u16 headaddr, u8  offset);
extern BOOLEAN WaitCPUMGQEmpty_8730A_ROM(void);
extern u8 PollingReg_8730A_ROM(u16 RegOffset, u8 PollingBit, u8 PollingResult, u16 PollingLimit, u16 *PollingCount);

#endif  /* #ifndef __ASSEMBLY__ */
#endif /* __WIFIFW_PACKET_H__ */
