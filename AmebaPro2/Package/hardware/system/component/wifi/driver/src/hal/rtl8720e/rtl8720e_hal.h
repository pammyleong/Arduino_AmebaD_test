...
#include "../../../../soc/amebalite/verification/wifi/amebad2_wifi_test.h"
#endif
...
void SetHalODMVar8720E(PADAPTER Adapter, HAL_ODM_VARIABLE eVariable, PVOID pValue1, BOOLEAN bSet);
void GetHalODMVar8720E(PADAPTER Adapter, HAL_ODM_VARIABLE eVariable, PVOID pValue1, PVOID pValue2);
...
#ifdef RTL8720E_WIFI_TEST//MBSSID
