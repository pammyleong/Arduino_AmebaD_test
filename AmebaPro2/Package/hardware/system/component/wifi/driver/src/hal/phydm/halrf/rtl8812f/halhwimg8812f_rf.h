 ...
 * #define CONFIG_8812F_TYPE5_DRV_DIS
 * #define CONFIG_8812F_TYPE6_DRV_DIS
 * #define CONFIG_8812F_TYPE7_DRV_DIS
 */
...
#define CONFIG_8812F_TYPE5
#ifdef CONFIG_8812F_TYPE5_DRV_DIS
    #undef CONFIG_8812F_TYPE5
#endif

#define CONFIG_8812F_TYPE6
#ifdef CONFIG_8812F_TYPE6_DRV_DIS
    #undef CONFIG_8812F_TYPE6
#endif

#define CONFIG_8812F_TYPE7
#ifdef CONFIG_8812F_TYPE7_DRV_DIS
    #undef CONFIG_8812F_TYPE7
#endif
...
/* tc: Test Chip, mp: mp Chip*/
void
odm_read_and_config_mp_8812f_txpowertrack_type5(struct dm_struct *dm);
u32 odm_get_version_mp_8812f_txpowertrack_type5(void);
...
/* tc: Test Chip, mp: mp Chip*/
void
odm_read_and_config_mp_8812f_txpowertrack_type6(struct dm_struct *dm);
u32 odm_get_version_mp_8812f_txpowertrack_type6(void);
...
/* tc: Test Chip, mp: mp Chip*/
void
odm_read_and_config_mp_8812f_txpowertrack_type7(struct dm_struct *dm);
u32 odm_get_version_mp_8812f_txpowertrack_type7(void);
