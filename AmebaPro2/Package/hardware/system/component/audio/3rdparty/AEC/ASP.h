...
void AEC_init(int16_t frame_size, int32_t sample_freq, AEC_CORE aec_core,
			  int filter_length, int16_t agc_mode, int16_t targetLevelDbfs, int16_t compression_gain_db, uint8_t limiter_enable, int16_t AGCAttackTime,
			  int16_t AGCReleaseTime, int ns_mode, float snd_amplification);
#elif defined(CONFIG_PLATFORM_8195BHP)
void AEC_init(int16_t frame_size, int32_t sample_freq, AEC_CORE aec_core,
			  int speex_filter_length, int16_t agc_mode, int16_t targetLevelDbfs, int16_t compression_gain_db, uint8_t limiter_enable, int ns_mode, float snd_amplification);
#define AEC_init_default() AEC_init(160, 8000, SPEEX_AEC, 160*20, 1, 0, 18, 0, 1, 1.0f)
#else
void AEC_init(int16_t frame_size, int32_t sample_freq, AEC_CORE aec_core,
...
//Setting for howling suppression
int AEC_process_h(const int16_t *farend, const int16_t *nearend, int16_t *out, int sDelay);
void set_agc_config_for_howling(int16_t targetLevelDbfs, int16_t compressionGaindB, uint8_t limiterEnable);
