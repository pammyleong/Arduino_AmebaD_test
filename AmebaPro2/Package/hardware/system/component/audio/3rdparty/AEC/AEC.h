...
void set_agc_config_for_webrtc(int16_t targetLevelDbfs, int16_t compressionGaindB, uint8_t limiterEnable);
void set_agc_config_for_webrtc_h(int16_t targetLevelDbfs, int16_t compressionGaindB, uint8_t limiterEnable);
