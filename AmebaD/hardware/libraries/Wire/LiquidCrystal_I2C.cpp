...
{
    // No need to use the delay routines since the time taken to write takes longer that what is needed both for toggling and enable pin an to execute the command.
    if (mode == FOUR_BITS) {
