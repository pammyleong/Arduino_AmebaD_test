...
extern void BC_cmd_task_init(uint8_t type);	//type = 0, bt config; type = 1, bt airsync config
...
void bt_config_wifi_init(uint8_t type);		//type = 0, bt config; type = 1, bt airsync config
