...
#endif
#if defined(POLARSSL_SRP_C)             /*!<  SRP key exchange       */
    srp_context srp_ctx;
#endif
...
#if defined(POLARSSL_KEY_EXCHANGE_SRP_ENABLED)
    /*
     * SRP values
     */
    unsigned char *srp_username;
    size_t         srp_username_len;
    unsigned char *srp_password;
    size_t         srp_password_len;
#endif
