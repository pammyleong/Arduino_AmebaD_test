...
#define HALMAC_RX_FIFO_SIZE_RX_FIFO_EXPANDING_1_BLOCK_8821C			49152 /* 48k */
...
#define HALMAC_PROT_MAX_AGG_PKT_LIMIT_8821C			0x2B
#define HALMAC_PROT_RTS_MAX_AGG_PKT_LIMIT_8821C		0x20
