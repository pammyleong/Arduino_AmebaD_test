...
#define P2PPS_GET_NOA_EN_SEL(__pH2C)    GET_H2C_FIELD(__pH2C + 0X08, 3, 1)
#define P2PPS_SET_NOA_EN_SEL(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X08, 3, 1, __Value)
#define P2PPS_SET_NOA_EN_SEL_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X08, 3, 1, __Value)
...
#define NAN_CHANNEL_PLAN_0_GET_START_TIME_SLOT_0(__pH2C)    GET_H2C_FIELD(__pH2C + 0X08, 8, 8)
#define NAN_CHANNEL_PLAN_0_SET_START_TIME_SLOT_0(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X08, 8, 8, __Value)
#define NAN_CHANNEL_PLAN_0_SET_START_TIME_SLOT_0_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X08, 8, 8, __Value)
#define NAN_CHANNEL_PLAN_0_GET_DURATION_0(__pH2C)    GET_H2C_FIELD(__pH2C + 0X08, 16, 8)
#define NAN_CHANNEL_PLAN_0_SET_DURATION_0(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X08, 16, 8, __Value)
#define NAN_CHANNEL_PLAN_0_SET_DURATION_0_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X08, 16, 8, __Value)
#define NAN_CHANNEL_PLAN_0_GET_CHANNEL_NUMBER_1(__pH2C)    GET_H2C_FIELD(__pH2C + 0X0C, 0, 8)
#define NAN_CHANNEL_PLAN_0_SET_CHANNEL_NUMBER_1(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X0C, 0, 8, __Value)
#define NAN_CHANNEL_PLAN_0_SET_CHANNEL_NUMBER_1_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X0C, 0, 8, __Value)
#define NAN_CHANNEL_PLAN_0_GET_START_TIME_SLOT_1(__pH2C)    GET_H2C_FIELD(__pH2C + 0X0C, 8, 8)
#define NAN_CHANNEL_PLAN_0_SET_START_TIME_SLOT_1(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X0C, 8, 8, __Value)
#define NAN_CHANNEL_PLAN_0_SET_START_TIME_SLOT_1_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X0C, 8, 8, __Value)
#define NAN_CHANNEL_PLAN_0_GET_DURATION_1(__pH2C)    GET_H2C_FIELD(__pH2C + 0X0C, 16, 8)
#define NAN_CHANNEL_PLAN_0_SET_DURATION_1(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X0C, 16, 8, __Value)
#define NAN_CHANNEL_PLAN_0_SET_DURATION_1_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X0C, 16, 8, __Value)
#define NAN_CHANNEL_PLAN_0_GET_CHANNEL_NUMBER_2(__pH2C)    GET_H2C_FIELD(__pH2C + 0X10, 0, 8)
#define NAN_CHANNEL_PLAN_0_SET_CHANNEL_NUMBER_2(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X10, 0, 8, __Value)
#define NAN_CHANNEL_PLAN_0_SET_CHANNEL_NUMBER_2_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X10, 0, 8, __Value)
#define NAN_CHANNEL_PLAN_0_GET_START_TIME_SLOT_2(__pH2C)    GET_H2C_FIELD(__pH2C + 0X10, 8, 8)
#define NAN_CHANNEL_PLAN_0_SET_START_TIME_SLOT_2(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X10, 8, 8, __Value)
#define NAN_CHANNEL_PLAN_0_SET_START_TIME_SLOT_2_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X10, 8, 8, __Value)
#define NAN_CHANNEL_PLAN_0_GET_DURATION_2(__pH2C)    GET_H2C_FIELD(__pH2C + 0X10, 16, 8)
#define NAN_CHANNEL_PLAN_0_SET_DURATION_2(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X10, 16, 8, __Value)
#define NAN_CHANNEL_PLAN_0_SET_DURATION_2_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X10, 16, 8, __Value)
#define NAN_CHANNEL_PLAN_0_GET_CHANNEL_NUMBER_3(__pH2C)    GET_H2C_FIELD(__pH2C + 0X14, 0, 8)
#define NAN_CHANNEL_PLAN_0_SET_CHANNEL_NUMBER_3(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X14, 0, 8, __Value)
#define NAN_CHANNEL_PLAN_0_SET_CHANNEL_NUMBER_3_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X14, 0, 8, __Value)
#define NAN_CHANNEL_PLAN_0_GET_START_TIME_SLOT_3(__pH2C)    GET_H2C_FIELD(__pH2C + 0X14, 8, 8)
#define NAN_CHANNEL_PLAN_0_SET_START_TIME_SLOT_3(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X14, 8, 8, __Value)
#define NAN_CHANNEL_PLAN_0_SET_START_TIME_SLOT_3_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X14, 8, 8, __Value)
#define NAN_CHANNEL_PLAN_0_GET_DURATION_3(__pH2C)    GET_H2C_FIELD(__pH2C + 0X14, 16, 8)
#define NAN_CHANNEL_PLAN_0_SET_DURATION_3(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X14, 16, 8, __Value)
#define NAN_CHANNEL_PLAN_0_SET_DURATION_3_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X14, 16, 8, __Value)
#define NAN_CHANNEL_PLAN_0_GET_CHANNEL_NUMBER_4(__pH2C)    GET_H2C_FIELD(__pH2C + 0X18, 0, 8)
#define NAN_CHANNEL_PLAN_0_SET_CHANNEL_NUMBER_4(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X18, 0, 8, __Value)
#define NAN_CHANNEL_PLAN_0_SET_CHANNEL_NUMBER_4_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X18, 0, 8, __Value)
#define NAN_CHANNEL_PLAN_0_GET_START_TIME_SLOT_4(__pH2C)    GET_H2C_FIELD(__pH2C + 0X18, 8, 8)
#define NAN_CHANNEL_PLAN_0_SET_START_TIME_SLOT_4(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X18, 8, 8, __Value)
#define NAN_CHANNEL_PLAN_0_SET_START_TIME_SLOT_4_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X18, 8, 8, __Value)
#define NAN_CHANNEL_PLAN_0_GET_DURATION_4(__pH2C)    GET_H2C_FIELD(__pH2C + 0X18, 16, 8)
#define NAN_CHANNEL_PLAN_0_SET_DURATION_4(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X18, 16, 8, __Value)
#define NAN_CHANNEL_PLAN_0_SET_DURATION_4_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X18, 16, 8, __Value)
#define NAN_CHANNEL_PLAN_0_GET_CHANNEL_NUMBER_5(__pH2C)    GET_H2C_FIELD(__pH2C + 0X1C, 0, 8)
#define NAN_CHANNEL_PLAN_0_SET_CHANNEL_NUMBER_5(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X1C, 0, 8, __Value)
#define NAN_CHANNEL_PLAN_0_SET_CHANNEL_NUMBER_5_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X1C, 0, 8, __Value)
#define NAN_CHANNEL_PLAN_0_GET_START_TIME_SLOT_5(__pH2C)    GET_H2C_FIELD(__pH2C + 0X1C, 8, 8)
#define NAN_CHANNEL_PLAN_0_SET_START_TIME_SLOT_5(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X1C, 8, 8, __Value)
#define NAN_CHANNEL_PLAN_0_SET_START_TIME_SLOT_5_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X1C, 8, 8, __Value)
#define NAN_CHANNEL_PLAN_0_GET_DURATION_5(__pH2C)    GET_H2C_FIELD(__pH2C + 0X1C, 16, 8)
#define NAN_CHANNEL_PLAN_0_SET_DURATION_5(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X1C, 16, 8, __Value)
#define NAN_CHANNEL_PLAN_0_SET_DURATION_5_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X1C, 16, 8, __Value)
#define NAN_CHANNEL_PLAN_1_GET_CHANNEL_NUMBER_6(__pH2C)    GET_H2C_FIELD(__pH2C + 0X08, 0, 8)
#define NAN_CHANNEL_PLAN_1_SET_CHANNEL_NUMBER_6(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X08, 0, 8, __Value)
#define NAN_CHANNEL_PLAN_1_SET_CHANNEL_NUMBER_6_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X08, 0, 8, __Value)
#define NAN_CHANNEL_PLAN_1_GET_START_TIME_SLOT_6(__pH2C)    GET_H2C_FIELD(__pH2C + 0X08, 8, 8)
#define NAN_CHANNEL_PLAN_1_SET_START_TIME_SLOT_6(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X08, 8, 8, __Value)
#define NAN_CHANNEL_PLAN_1_SET_START_TIME_SLOT_6_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X08, 8, 8, __Value)
#define NAN_CHANNEL_PLAN_1_GET_DURATION_6(__pH2C)    GET_H2C_FIELD(__pH2C + 0X08, 16, 8)
#define NAN_CHANNEL_PLAN_1_SET_DURATION_6(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X08, 16, 8, __Value)
#define NAN_CHANNEL_PLAN_1_SET_DURATION_6_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X08, 16, 8, __Value)
#define NAN_CHANNEL_PLAN_1_GET_CHANNEL_NUMBER_7(__pH2C)    GET_H2C_FIELD(__pH2C + 0X0C, 0, 8)
#define NAN_CHANNEL_PLAN_1_SET_CHANNEL_NUMBER_7(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X0C, 0, 8, __Value)
#define NAN_CHANNEL_PLAN_1_SET_CHANNEL_NUMBER_7_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X0C, 0, 8, __Value)
#define NAN_CHANNEL_PLAN_1_GET_START_TIME_SLOT_7(__pH2C)    GET_H2C_FIELD(__pH2C + 0X0C, 8, 8)
#define NAN_CHANNEL_PLAN_1_SET_START_TIME_SLOT_7(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X0C, 8, 8, __Value)
#define NAN_CHANNEL_PLAN_1_SET_START_TIME_SLOT_7_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X0C, 8, 8, __Value)
#define NAN_CHANNEL_PLAN_1_GET_DURATION_7(__pH2C)    GET_H2C_FIELD(__pH2C + 0X0C, 16, 8)
#define NAN_CHANNEL_PLAN_1_SET_DURATION_7(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X0C, 16, 8, __Value)
#define NAN_CHANNEL_PLAN_1_SET_DURATION_7_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X0C, 16, 8, __Value)
#define NAN_CHANNEL_PLAN_1_GET_CHANNEL_NUMBER_8(__pH2C)    GET_H2C_FIELD(__pH2C + 0X10, 0, 8)
#define NAN_CHANNEL_PLAN_1_SET_CHANNEL_NUMBER_8(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X10, 0, 8, __Value)
#define NAN_CHANNEL_PLAN_1_SET_CHANNEL_NUMBER_8_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X10, 0, 8, __Value)
#define NAN_CHANNEL_PLAN_1_GET_START_TIME_SLOT_8(__pH2C)    GET_H2C_FIELD(__pH2C + 0X10, 8, 8)
#define NAN_CHANNEL_PLAN_1_SET_START_TIME_SLOT_8(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X10, 8, 8, __Value)
#define NAN_CHANNEL_PLAN_1_SET_START_TIME_SLOT_8_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X10, 8, 8, __Value)
#define NAN_CHANNEL_PLAN_1_GET_DURATION_8(__pH2C)    GET_H2C_FIELD(__pH2C + 0X10, 16, 8)
#define NAN_CHANNEL_PLAN_1_SET_DURATION_8(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X10, 16, 8, __Value)
#define NAN_CHANNEL_PLAN_1_SET_DURATION_8_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X10, 16, 8, __Value)
#define NAN_CHANNEL_PLAN_1_GET_CHANNEL_NUMBER_9(__pH2C)    GET_H2C_FIELD(__pH2C + 0X14, 0, 8)
#define NAN_CHANNEL_PLAN_1_SET_CHANNEL_NUMBER_9(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X14, 0, 8, __Value)
#define NAN_CHANNEL_PLAN_1_SET_CHANNEL_NUMBER_9_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X14, 0, 8, __Value)
#define NAN_CHANNEL_PLAN_1_GET_START_TIME_SLOT_9(__pH2C)    GET_H2C_FIELD(__pH2C + 0X14, 8, 8)
#define NAN_CHANNEL_PLAN_1_SET_START_TIME_SLOT_9(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X14, 8, 8, __Value)
#define NAN_CHANNEL_PLAN_1_SET_START_TIME_SLOT_9_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X14, 8, 8, __Value)
#define NAN_CHANNEL_PLAN_1_GET_DURATION_9(__pH2C)    GET_H2C_FIELD(__pH2C + 0X14, 16, 8)
#define NAN_CHANNEL_PLAN_1_SET_DURATION_9(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X14, 16, 8, __Value)
#define NAN_CHANNEL_PLAN_1_SET_DURATION_9_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X14, 16, 8, __Value)
#define NAN_CHANNEL_PLAN_1_GET_CHANNEL_NUMBER_10(__pH2C)    GET_H2C_FIELD(__pH2C + 0X18, 0, 8)
#define NAN_CHANNEL_PLAN_1_SET_CHANNEL_NUMBER_10(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X18, 0, 8, __Value)
#define NAN_CHANNEL_PLAN_1_SET_CHANNEL_NUMBER_10_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X18, 0, 8, __Value)
#define NAN_CHANNEL_PLAN_1_GET_START_TIME_SLOT_10(__pH2C)    GET_H2C_FIELD(__pH2C + 0X18, 8, 8)
#define NAN_CHANNEL_PLAN_1_SET_START_TIME_SLOT_10(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X18, 8, 8, __Value)
#define NAN_CHANNEL_PLAN_1_SET_START_TIME_SLOT_10_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X18, 8, 8, __Value)
#define NAN_CHANNEL_PLAN_1_GET_DURATION_10(__pH2C)    GET_H2C_FIELD(__pH2C + 0X18, 16, 8)
#define NAN_CHANNEL_PLAN_1_SET_DURATION_10(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X18, 16, 8, __Value)
#define NAN_CHANNEL_PLAN_1_SET_DURATION_10_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X18, 16, 8, __Value)
#define NAN_CHANNEL_PLAN_1_GET_CHANNEL_NUMBER_11(__pH2C)    GET_H2C_FIELD(__pH2C + 0X1C, 0, 8)
#define NAN_CHANNEL_PLAN_1_SET_CHANNEL_NUMBER_11(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X1C, 0, 8, __Value)
#define NAN_CHANNEL_PLAN_1_SET_CHANNEL_NUMBER_11_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X1C, 0, 8, __Value)
#define NAN_CHANNEL_PLAN_1_GET_START_TIME_SLOT_11(__pH2C)    GET_H2C_FIELD(__pH2C + 0X1C, 8, 8)
#define NAN_CHANNEL_PLAN_1_SET_START_TIME_SLOT_11(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X1C, 8, 8, __Value)
#define NAN_CHANNEL_PLAN_1_SET_START_TIME_SLOT_11_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X1C, 8, 8, __Value)
#define NAN_CHANNEL_PLAN_1_GET_DURATION_11(__pH2C)    GET_H2C_FIELD(__pH2C + 0X1C, 16, 8)
#define NAN_CHANNEL_PLAN_1_SET_DURATION_11(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X1C, 16, 8, __Value)
#define NAN_CHANNEL_PLAN_1_SET_DURATION_11_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X1C, 16, 8, __Value)
#endif
