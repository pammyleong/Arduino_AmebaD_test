...
#define POLARSSL_MPI_MAX_SIZE             256 /**< Maximum number of bytes for usable MPIs. Default in 512.
                                                   POLARSSL_MPI_MAX_SIZE 256 for bignum and premaster size is only verified for SSL RSA handshake */
// CTR_DRBG options
//
...
// SSL options
//
#define SSL_MAX_CONTENT_LEN              768 /**< Size of the input / output buffer. Default in 16384.
                                                   SSL_MAX_CONTENT_LEN 768 is only verified for SSL RSA handshake */
