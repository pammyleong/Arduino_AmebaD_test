...
#define H2C_8711B_PSTUNEPARAM_LEN			4
...
typedef struct _RSVDPAGE_LOC {
	...
	u8 LocNetList;
#endif //CONFIG_WOWLAN	
} RSVDPAGE_LOC_8711B, *PRSVDPAGE_LOC_8711B;
...
void rtl8711b_fw_try_ap_cmd(PADAPTER padapter, u32 need_ack);
...
#ifdef CONFIG_WOWLAN
void rtl8711b_set_wowlan_cmd(_adapter* padapter, u8 enable);
void SetFwRelatedForWoWLAN8711b(_adapter* padapter, u8 bHostIsGoingtoSleep);
#endif//CONFIG_WOWLAN
