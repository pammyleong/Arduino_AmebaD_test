...
#define ANT_CTRL_BY_PTA     0x6600
#define ANT_CTRL_BY_BBSW    0x7700
...
//Jimmy 
#define ANT_092C_CTRL_WIFI          0x04
#define ANT_092C_CTRL_BT            0x08
...
{
    NETWORK_TYPE_AP             = 0,        
    NETWORK_TYPE_CLIENT         = 1,
}NETWORK_TYPE, *PNETWORK_TYPE;
...
void PMUDeInitial(PADAPTER padapter);
