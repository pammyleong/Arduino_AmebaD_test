...
#ifndef _RTL8195A_NFC_TEST_H_
#define _RTL8195A_NFC_TEST_H_

#ifdef CONFIG_NFC_VERIFY
#include "osdep_api.h"
#define N2A_Q_LENGTH 10
#define N2ARLENGTH    4
#define NFCTAGLENGTH 42
...
u32 AppFlashRead(IN u32 Length, IN u32 *RData);
VOID AppFlashWrite(IN u32 Length, IN u32 *WData);
u32 NFCAppTagRead(IN u32 Length, IN u32 *TagData);
VOID NFCAppTagWrite(IN u32 Length, IN u32 *TagData);

#endif  //#ifdef CONFIG_NFC_VERIFY
#endif
