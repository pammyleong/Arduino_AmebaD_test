...
extern _LONG_CALL_ROM_ float __rtl_fabsf_v1_00(float);
extern _LONG_CALL_ROM_ double __rtl_fabs_v1_00(double);

extern _LONG_CALL_ROM_ float __rtl_cos_f32_v1_00(float x);
extern _LONG_CALL_ROM_ float __rtl_sin_f32_v1_00(float x);

extern _LONG_CALL_ROM_ void __rtl_mult_f32_array_v1_00(
