...
typedef struct rtos_function{
	// task.h
	TaskHandle_t* (*taskCreate)( TaskFunction_t pxTaskCode, uint16_t usSecureStackDepth, void * pvParameters, UBaseType_t uxPriority);
	...
	BaseType_t (*queueGenericSend)( QueueHandle_t xQueue, void * pvItemToQueue, TickType_t xTicksToWait, BaseType_t xCopyPosition );
